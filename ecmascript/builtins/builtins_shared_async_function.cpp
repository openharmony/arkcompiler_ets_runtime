...
{
    ASSERT(argv);
    BUILTINS_API_TRACE(argv->GetThread(), SharedAsyncFunction, Constructor);
    // not support
    THROW_TYPE_ERROR_AND_RETURN(argv->GetThread(), "Not support eval. Forbidden using new SharedAsyncFunction().",
