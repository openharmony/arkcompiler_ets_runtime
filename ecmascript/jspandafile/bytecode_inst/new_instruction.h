...
enum class Opcode {
    ...
    ASYNCGENERATORRESOLVE_V8_V8_V8 = 29,
    CREATEARRAYWITHBUFFER_IMM8_ID16 = 30,
    CREATEARRAYWITHBUFFER_IMM16_ID16 = 31,
    CALLTHIS0_IMM8_V8 = 32,
    CALLTHIS1_IMM8_V8_V8 = 33,
    ...
    ISTRUE = 74,
    ISFALSE = 75,
    CALLTHIS2_IMM8_V8_V8_V8 = 76,
    CALLTHIS3_IMM8_V8_V8_V8_V8 = 77,
    CALLTHISRANGE_IMM8_IMM8_V8 = 78,
    SUPERCALLTHISRANGE_IMM8_IMM8_V8 = 79,
    SUPERCALLARROWRANGE_IMM8_IMM8_V8 = 80,
    DEFINEFUNC_IMM8_ID16_IMM8 = 81,
    DEFINEFUNC_IMM16_ID16_IMM8 = 82,
    DEFINEMETHOD_IMM8_ID16_IMM8 = 83,
    CALLARG0_IMM8 = 84,
    ...
    DEFINEMETHOD_IMM16_ID16_IMM8 = 90,
    LDEXTERNALMODULEVAR_IMM8 = 91,
    ...
    JNSTRICTEQZ_IMM8 = 161,
    JNSTRICTEQZ_IMM16 = 162,
    JEQNULL_IMM8 = 163,
    JEQNULL_IMM16 = 164,
    ...
    JSTRICTEQNULL_IMM8 = 187,
    STLEXVAR_IMM8_IMM8 = 188,
    JSTRICTEQNULL_IMM16 = 189,
    CALLARG1_IMM8_V8 = 190,
    JNSTRICTEQNULL_IMM8 = 191,
    JNSTRICTEQNULL_IMM16 = 192,
    JEQUNDEFINED_IMM8 = 193,
    JEQUNDEFINED_IMM16 = 194,
    JNEUNDEFINED_IMM8 = 195,
    JNEUNDEFINED_IMM16 = 196,
    JSTRICTEQUNDEFINED_IMM8 = 197,
    JSTRICTEQUNDEFINED_IMM16 = 198,
    JNSTRICTEQUNDEFINED_IMM8 = 199,
    JNSTRICTEQUNDEFINED_IMM16 = 200,
    JEQ_V8_IMM8 = 201,
    JEQ_V8_IMM16 = 202,
    JNE_V8_IMM8 = 203,
    JNE_V8_IMM16 = 204,
    JSTRICTEQ_V8_IMM8 = 205,
    JSTRICTEQ_V8_IMM16 = 206,
    JNSTRICTEQ_V8_IMM8 = 207,
    JNSTRICTEQ_V8_IMM16 = 208,
    MOV_V4_V4 = 209,
    MOV_V8_V8 = 210,
    MOV_V16_V16 = 211,
    NOP = 212,
...
template<const BytecodeInstMode Mode> inline bool BytecodeInst<Mode>::HasFlag(Flags flag) const {
    ...
    case BytecodeInst<Mode>::Opcode::GETNEXTPROPNAME_V8:
        return ((Flags::ACC_READ | Flags::ACC_WRITE | Flags::ACC_WRITE) & flag) == flag;  // NOLINT(hicpp-signed-bitwise)
    case BytecodeInst<Mode>::Opcode::JSTRICTEQZ_IMM8:
        return ((Flags::JUMP | Flags::ACC_READ) & flag) == flag;  // NOLINT(hicpp-signed-bitwise)
    case BytecodeInst<Mode>::Opcode::JSTRICTEQZ_IMM16:
        return ((Flags::JUMP | Flags::ACC_READ) & flag) == flag;  // NOLINT(hicpp-signed-bitwise)
    case BytecodeInst<Mode>::Opcode::SETOBJECTWITHPROTO_IMM8_V8:
        return ((Flags::ACC_READ | Flags::ACC_WRITE | Flags::IC_SLOT | Flags::TWO_SLOT | Flags::ACC_READ) & flag) == flag;  // NOLINT(hicpp-signed-bitwise)
