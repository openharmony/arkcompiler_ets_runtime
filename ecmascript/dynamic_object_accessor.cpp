...
JSTaggedValue DynamicObjectAccessor::GetProperty(ThreadHolder *thread,
                                                 const BaseObject *obj,
                                                 const char *name) const
{
    JSThread *jsThread = thread->GetJSThread();
...
bool DynamicObjectAccessor::SetProperty(ThreadHolder *thread,
                                        BaseObject *obj,
                                        const char *name,
                                        JSTaggedValue value)
{
...
bool DynamicObjectAccessor::HasElementByIdx(ThreadHolder *thread,
                                            const BaseObject *obj,
...
JSTaggedValue DynamicObjectAccessor::GetElementByIdx(ThreadHolder *thread,
                                                     const BaseObject *obj,
                                                     const uint32_t index) const
{
    JSThread *jsThread = thread->GetJSThread();
...
bool DynamicObjectAccessor::SetElementByIdx(ThreadHolder *thread,
                                            BaseObject *obj,
