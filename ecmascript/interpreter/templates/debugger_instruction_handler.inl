 ...
 */
    ...
    DEBUG_HANDLE_OPCODE(CALLTHIS0WITHNAME_IMM8_ID16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::CALLTHIS0WITHNAME_IMM8_ID16_V8);
    }
    DEBUG_HANDLE_OPCODE(CALLTHIS1WITHNAME_IMM8_ID16_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::CALLTHIS1WITHNAME_IMM8_ID16_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(CALLTHIS2WITHNAME_IMM8_ID16_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::CALLTHIS2WITHNAME_IMM8_ID16_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(CALLTHIS3WITHNAME_IMM8_ID16_V8_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::CALLTHIS3WITHNAME_IMM8_ID16_V8_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(CALLTHISRANGEWITHNAME_IMM8_IMM8_ID16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::CALLTHISRANGEWITHNAME_IMM8_IMM8_ID16_V8);
    }
