 ...
 */
    ...
    HANDLE_OPCODE(DEBUG_HANDLE_ASYNCGENERATORREJECT_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::ASYNCGENERATORREJECT_PREF_V8_V8);
    }
    ...
    HANDLE_OPCODE(DEBUG_HANDLE_LDPATCHVAR_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::LDPATCHVAR_PREF_IMM16);
    }
    HANDLE_OPCODE(DEBUG_HANDLE_STPATCHVAR_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::STPATCHVAR_PREF_IMM16);
    }
