 ...
 */
    ...
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::WIDE_LDPATCHVAR_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(WIDE_STPATCHVAR_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::WIDE_STPATCHVAR_PREF_IMM16);
    }
    ...
    DEBUG_HANDLE_OPCODE(DEPRECATED_DYNAMICIMPORT_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
