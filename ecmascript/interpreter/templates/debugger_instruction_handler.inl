 ...
 */
    ...
    DEBUG_HANDLE_OPCODE(LDGLOBALTHIS)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::LDGLOBALTHIS);
    }
    ...
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLRANGE_PREF_IMM16_V8);
    }
    ...
    {
        NOTIFY_DEBUGGER_EVENT();
        DEBUG_DISPATCH_THROW();
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDLEXENV_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDLEXENV_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(WIDE_CREATEOBJECTWITHEXCLUDEDKEYS_PREF_IMM16_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_CREATEOBJECTWITHEXCLUDEDKEYS_PREF_IMM16_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(THROW_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_POPLEXENV_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_POPLEXENV_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(WIDE_NEWOBJRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_NEWOBJRANGE_PREF_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(THROW_NOTEXISTS_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_NOTEXISTS_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_GETITERATORNEXT_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_GETITERATORNEXT_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_NEWLEXENV_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_NEWLEXENV_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(THROW_PATTERNNONCOERCIBLE_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_PATTERNNONCOERCIBLE_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CREATEARRAYWITHBUFFER_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CREATEARRAYWITHBUFFER_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(WIDE_NEWLEXENVWITHNAME_PREF_IMM16_ID16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_NEWLEXENVWITHNAME_PREF_IMM16_ID16);
    }
    DEBUG_HANDLE_OPCODE(THROW_DELETESUPERPROPERTY_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_DELETESUPERPROPERTY_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CREATEOBJECTWITHBUFFER_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CREATEOBJECTWITHBUFFER_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(WIDE_CALLRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_CALLRANGE_PREF_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(THROW_CONSTASSIGNMENT_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_CONSTASSIGNMENT_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_TONUMBER_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_TONUMBER_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_CALLTHISRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_CALLTHISRANGE_PREF_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLTHISRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLTHISRANGE_PREF_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(THROW_IFNOTOBJECT_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_IFNOTOBJECT_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_TONUMERIC_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_TONUMERIC_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_SUPERCALLTHISRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_SUPERCALLTHISRANGE_PREF_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(THROW_UNDEFINEDIFHOLE_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_UNDEFINEDIFHOLE_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_NEG_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_NEG_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_SUPERCALLARROWRANGE_PREF_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_SUPERCALLARROWRANGE_PREF_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(THROW_IFSUPERNOTCORRECTCALL_PREF_IMM8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_IFSUPERNOTCORRECTCALL_PREF_IMM8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_NOT_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_NOT_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_LDOBJBYINDEX_PREF_IMM32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_LDOBJBYINDEX_PREF_IMM32);
    }
    DEBUG_HANDLE_OPCODE(THROW_IFSUPERNOTCORRECTCALL_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::THROW_IFSUPERNOTCORRECTCALL_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_INC_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_INC_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_STOBJBYINDEX_PREF_V8_IMM32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_STOBJBYINDEX_PREF_V8_IMM32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEC_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEC_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_STOWNBYINDEX_PREF_V8_IMM32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_STOWNBYINDEX_PREF_V8_IMM32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLARG0_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLARG0_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_COPYRESTARGS_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_COPYRESTARGS_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLARG1_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLARG1_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_LDLEXVAR_PREF_IMM16_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_LDLEXVAR_PREF_IMM16_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLARGS2_PREF_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLARGS2_PREF_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_STLEXVAR_PREF_IMM16_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_STLEXVAR_PREF_IMM16_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLARGS3_PREF_V8_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLARGS3_PREF_V8_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_GETMODULENAMESPACE_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_GETMODULENAMESPACE_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CALLSPREAD_PREF_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CALLSPREAD_PREF_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_STMODULEVAR_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_STMODULEVAR_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINEFUNC_PREF_ID16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINEFUNC_PREF_ID16_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_LDLOCALMODULEVAR_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_LDLOCALMODULEVAR_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINENCFUNC_PREF_ID16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINENCFUNC_PREF_ID16_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(WIDE_LDEXTERNALMODULEVAR_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::WIDE_LDEXTERNALMODULEVAR_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINEGENERATORFUNC_PREF_ID16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINEGENERATORFUNC_PREF_ID16_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINEASYNCFUNC_PREF_ID16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINEASYNCFUNC_PREF_ID16_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINEMETHOD_PREF_ID16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINEMETHOD_PREF_ID16_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINECLASSWITHBUFFER_PREF_ID16_IMM16_IMM16_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINECLASSWITHBUFFER_PREF_ID16_IMM16_IMM16_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_RESUMEGENERATOR_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_RESUMEGENERATOR_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_GETRESUMEMODE_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_GETRESUMEMODE_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_GETTEMPLATEOBJECT_PREF_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_GETTEMPLATEOBJECT_PREF_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DELOBJPROP_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DELOBJPROP_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_SUSPENDGENERATOR_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_SUSPENDGENERATOR_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_ASYNCFUNCTIONAWAITUNCAUGHT_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_ASYNCFUNCTIONAWAITUNCAUGHT_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_COPYDATAPROPERTIES_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_COPYDATAPROPERTIES_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_SETOBJECTWITHPROTO_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_SETOBJECTWITHPROTO_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDOBJBYVALUE_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDOBJBYVALUE_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDSUPERBYVALUE_PREF_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDSUPERBYVALUE_PREF_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDOBJBYINDEX_PREF_V8_IMM32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDOBJBYINDEX_PREF_V8_IMM32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_ASYNCFUNCTIONRESOLVE_PREF_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_ASYNCFUNCTIONRESOLVE_PREF_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_ASYNCFUNCTIONREJECT_PREF_V8_V8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_ASYNCFUNCTIONREJECT_PREF_V8_V8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STLEXVAR_PREF_IMM4_IMM4_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STLEXVAR_PREF_IMM4_IMM4_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STLEXVAR_PREF_IMM8_IMM8_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STLEXVAR_PREF_IMM8_IMM8_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STLEXVAR_PREF_IMM16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STLEXVAR_PREF_IMM16_IMM16_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_GETMODULENAMESPACE_PREF_ID32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_GETMODULENAMESPACE_PREF_ID32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STMODULEVAR_PREF_ID32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STMODULEVAR_PREF_ID32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDOBJBYNAME_PREF_ID32_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDOBJBYNAME_PREF_ID32_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDSUPERBYNAME_PREF_ID32_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDSUPERBYNAME_PREF_ID32_V8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDMODULEVAR_PREF_ID32_IMM8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDMODULEVAR_PREF_ID32_IMM8);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STCONSTTOGLOBALRECORD_PREF_ID32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STCONSTTOGLOBALRECORD_PREF_ID32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STLETTOGLOBALRECORD_PREF_ID32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STLETTOGLOBALRECORD_PREF_ID32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_STCLASSTOGLOBALRECORD_PREF_ID32)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_STCLASSTOGLOBALRECORD_PREF_ID32);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_LDHOMEOBJECT_PREF_NONE)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_LDHOMEOBJECT_PREF_NONE);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_CREATEOBJECTHAVINGMETHOD_PREF_IMM16)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_CREATEOBJECTHAVINGMETHOD_PREF_IMM16);
    }
    DEBUG_HANDLE_OPCODE(DEPRECATED_DEFINEASYNCGENERATORFUNC_PREF_ID16_IMM16_V8)
    {
        NOTIFY_DEBUGGER_EVENT();
        REAL_GOTO_SECOND_DISPATCH_OPCODE(EcmaOpcode::DEPRECATED_DEFINEASYNCGENERATORFUNC_PREF_ID16_IMM16_V8);
    }
