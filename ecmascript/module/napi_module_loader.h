...
public:
    static JSHandle<JSTaggedValue> LoadModuleNameSpace(EcmaVM *vm, CString requestPath,
                                                       const CString& moduleName, CString &abcFilePath, bool isHybrid = false);
    static JSHandle<JSTaggedValue> LoadModuleNameSpace(EcmaVM *vm, CString requestPath, CString modulePath, bool isHybrid = false);
...
private:
    static JSHandle<JSTaggedValue> LoadModuleNameSpaceWithModuleInfo(EcmaVM *vm, CString &requestPath,
                                                                     CString &modulePath, CString &abcFilePath, bool isHybrid = false);
    ...
    static JSHandle<JSTaggedValue> LoadFilePathWithinModule(JSThread *thread, const CString& abcFilePath,
                                                            const CString& srcPrefix, const CString& requestPath, const CString& modulePath, bool isHybrid = false);
};
}
