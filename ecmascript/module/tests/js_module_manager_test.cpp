...
HWTEST_F_L0(ModuleManagerTest, ModuleManager_ProcessPendingRemovalModules_DeadModule)
{
    ModuleManager *moduleManager = thread->GetModuleManager();
...
HWTEST_F_L0(ModuleManagerTest, ModuleManager_ProcessPendingRemovalModules_ForwardedModule)
{
    ModuleManager *moduleManager = thread->GetModuleManager();
    ...
    instance->ProcessPendingRemovalModules(visitor);
...
HWTEST_F_L0(ModuleManagerTest, EcmaVM_ProcessPendingRemovalModules_NoJSThread)
{
...
HWTEST_F_L0(ModuleManagerTest, EcmaVM_ProcessPendingRemovalModules_NoModuleManager)
{
