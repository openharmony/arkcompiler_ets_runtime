                                                                            ...
                                                                            bool isHybrid)
{
    ...
    if (!modulePath.empty()) {
        curJsPandaFile = JSPandaFileManager::GetInstance()->LoadJSPandaFile(thread,
            abcFilePath, requestPath, false, isHybrid, ExecuteTypes::NAPI);
...
JSHandle<JSTaggedValue> NapiModuleLoader::LoadModuleNameSpace(EcmaVM *vm,
                                                              CString requestPath,
                                                              CString modulePath,
                                                              bool isHybrid)
{
