...
public:
    ...
    ACCESSORS_ASAN_CHECK(MachineCode, MACHINECODE_OFFSET, BASELINECODE_OFFSET, IsNotJSApiFunction)
    ACCESSORS_ASAN_CHECK(BaselineCode, BASELINECODE_OFFSET, ECMA_MODULE_OFFSET, IsNotJSApiFunction)
#if ENABLE_MEMORY_OPTIMIZATION
    ACCESSORS_ASAN_CHECK(Module, ECMA_MODULE_OFFSET, LAST_OFFSET, IsNotJSApiFunction)
    DEFINE_ALIGN_SIZE(LAST_OFFSET);

    DECL_VISIT_OBJECT_FOR_JS_OBJECT(JSApiFunction, RAW_PROFILE_TYPE_INFO_OFFSET, LAST_OFFSET)
#else
