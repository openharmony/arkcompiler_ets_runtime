...
public:
    explicit JSMetadataTestHelper()
    {
        ...
        fieldNameTable_ = {
            ...
            {JSType::IMPORTENTRY_RECORD, {"ModuleRequest", "ImportName", "LocalName", "IMPORTENTRY_RECORD"}},
            {JSType::INDIRECT_EXPORTENTRY_RECORD, {"ExportName", "ModuleRequest",
                                                   "ImportName", "INDIRECT_EXPORTENTRY_RECORD"}},
            ...
            {JSType::JS_FUNCTION, {"ProtoOrHClass", "LexicalEnv", "MachineCode", "BaselineCode", "RawProfileTypeInfo",
                                   "HomeObject", "Module", "ProtoTransRootHClass", "JS_FUNCTION"}},
            ...
            {JSType::SOURCE_TEXT_MODULE_RECORD, {"Environment", "Namespace", "RequestedModules",
                                                 "ImportEntries", "LocalExportEntries",
                                                 "IndirectExportEntries", "StarExportEntries",
                                                 "NameDictionary", "CycleRoot", "TopLevelCapability",
                                                 "AsyncParentModules", "SendableEnv", "SOURCE_TEXT_MODULE_RECORD"}},
        ...
        fieldOffsetTable_ = {
            ...
            {JSType::CLASS_INFO_EXTRACTOR, {
                ...
                ClassInfoExtractor::LAST_OFFSET - ClassInfoExtractor::PROTOTYPE_HCLASS_OFFSET}},
            {JSType::CLASS_LITERAL, {ClassLiteral::ARRAY_OFFSET,
                                     ClassLiteral::LAST_OFFSET - ClassLiteral::ARRAY_OFFSET}},
            {JSType::COMPLETION_RECORD, {CompletionRecord::VALUE_OFFSET,
                                         CompletionRecord::LAST_OFFSET - CompletionRecord::VALUE_OFFSET}},
            ...
            {JSType::FUNCTION_TEMPLATE, {FunctionTemplate::METHOD_OFFSET,
                                         ...
                                         FunctionTemplate::LAST_OFFSET - FunctionTemplate::METHOD_OFFSET}},
            {JSType::GLOBAL_ENV, {GlobalEnv::SIZE - GlobalEnv::HEADER_SIZE}},
            {JSType::IMPORTENTRY_RECORD, {ImportEntry::IMPORT_ENTRY_OFFSET,
                                          ImportEntry::MODULE_REQUEST_OFFSET,
                                          ImportEntry::IMPORT_NAME_OFFSET,
            ...
            {JSType::INDIRECT_EXPORTENTRY_RECORD, {
                ...
                IndirectExportEntry::MODULE_REQUEST_OFFSET,
            ...
            {JSType::JS_API_ARRAYLIST_ITERATOR, {
                ...
                JSAPIArrayListIterator::LAST_OFFSET - JSAPIArrayListIterator::ITERATED_ARRAYLIST_OFFSET}},
            ...
            {JSType::JS_API_BITVECTOR_ITERATOR, {
                ...
                JSAPIBitVectorIterator::LAST_OFFSET - JSAPIBitVectorIterator::ITERATED_BITVECTOR_OFFSET}},
            ...
            {JSType::JS_API_DEQUE_ITERATOR, {JSAPIDequeIterator::ITERATED_DEQUE_OFFSET,
                                             JSAPIDequeIterator::LAST_OFFSET - JSAPIDequeIterator::ITERATED_DEQUE_OFFSET}},
            ...
            {JSType::JS_API_HASHSET_ITERATOR, {
                ...
                JSAPIHashSetIterator::LAST_OFFSET - JSAPIHashSetIterator::ITERATED_HASHSET_OFFSET}},
            ...
            {JSType::JS_API_HASH_SET, {JSAPIHashSet::HASHSET_TABLE_INDEX,
                                       JSAPIHashSet::LAST_OFFSET - JSAPIHashSet::HASHSET_TABLE_INDEX}},
            {JSType::JS_API_LIGHT_WEIGHT_MAP, {
                ...
                JSAPILightWeightMap::LAST_OFFSET - JSAPILightWeightMap::LWP_HASHES_OFFSET}},
            ...
            {JSType::JS_API_LIGHT_WEIGHT_SET, {
                ...
                JSAPILightWeightSet::LAST_OFFSET - JSAPILightWeightSet::HASHES_OFFSET}},
            ...
            {JSType::JS_API_LIST, {JSAPIList::SINGLY_LIST_OFFSET,
                                   JSAPIList::LAST_OFFSET - JSAPIList::SINGLY_LIST_OFFSET}},
            ...
            {JSType::JS_API_PLAIN_ARRAY, {JSAPIPlainArray::KEYS_OFFSET,
                                          ...
                                          JSAPIPlainArray::LAST_OFFSET - JSAPIPlainArray::KEYS_OFFSET}},
            ...
            {JSType::JS_API_QUEUE_ITERATOR, {
                ...
                JSAPIQueueIterator::LAST_OFFSET - JSAPIQueueIterator::ITERATED_QUEUE_OFFSET}},
            {JSType::JS_API_STACK, {JSAPIStack::LAST_OFFSET - JSAPIStack::TOP_OFFSET}},
            {JSType::JS_API_STACK_ITERATOR, {
                JSAPIStackIterator::ITERATED_STACK_OFFSET,
                JSAPIStackIterator::LAST_OFFSET - JSAPIStackIterator::ITERATED_STACK_OFFSET}},
            ...
            {JSType::JS_API_VECTOR, {JSAPIVector::ENDL_OFFSET - JSAPIVector::ELEMENT_COUNT_OFFSET}},
            ...
            {JSType::JS_BIGINT64_ARRAY, {JSTypedArray::VIEWED_ARRAY_BUFFER_OFFSET,
                                         ...
                                         JSTypedArray::LAST_OFFSET - JSTypedArray::VIEWED_ARRAY_BUFFER_OFFSET}},
            ...
            {JSType::JS_COLLATOR, {JSCollator::ICU_FIELD_OFFSET,
                                   ...
                                   JSCollator::LAST_OFFSET - JSCollator::ICU_FIELD_OFFSET}},
            ...
            {JSType::JS_DATE_TIME_FORMAT, {JSDateTimeFormat::LOCALE_OFFSET,
                                           ...
                                           JSDateTimeFormat::LAST_OFFSET - JSDateTimeFormat::LOCALE_OFFSET}},
            {JSType::JS_DISPLAYNAMES, {JSDisplayNames::LOCALE_OFFSET,
                                       JSDisplayNames::ICU_LOCALE_DISPPLAY_NAMES,
                                       JSDisplayNames::LAST_OFFSET - JSDisplayNames::LOCALE_OFFSET}},
            ...
            {JSType::JS_FUNCTION, {JSFunction::PROTO_OR_DYNCLASS_OFFSET,
                                   ...
                                   JSFunction::PROTO_TRANS_ROOT_HCLASS_OFFSET,
            ...
            {JSType::JS_GENERATOR_OBJECT, {
                ...
                JSGeneratorObject::LAST_OFFSET - JSGeneratorObject::GENERATOR_CONTEXT_OFFSET}},
            ...
            {JSType::JS_LIST_FORMAT, {JSListFormat::LOCALE_OFFSET,
                                      ...
                                      JSListFormat::LAST_OFFSET - JSListFormat::LOCALE_OFFSET}},
            ...
            {JSType::JS_NUMBER_FORMAT, {JSNumberFormat::LOCALE_OFFSET,
                                        ...
                                        JSNumberFormat::LAST_OFFSET - JSNumberFormat::LOCALE_OFFSET}},
            ...
            {JSType::JS_PLURAL_RULES, {JSPluralRules::LOCALE_OFFSET,
                                       ...
                                       JSPluralRules::LAST_OFFSET - JSPluralRules::LOCALE_OFFSET}},
            ...
            {JSType::JS_PROMISE, {JSPromise::PROMISE_RESULT_OFFSET,
                                  ...
                                  JSPromise::LAST_OFFSET - JSPromise::PROMISE_RESULT_OFFSET}},
            ...
            {JSType::JS_PROMISE_ALL_SETTLED_ELEMENT_FUNCTION, {
                ...
                JSPromiseAllSettledElementFunction::LAST_OFFSET - JSPromiseAllSettledElementFunction::ALREADY_CALLED_OFFSET}},
            {JSType::JS_PROMISE_ANY_REJECT_ELEMENT_FUNCTION, {
                ...
                JSPromiseAnyRejectElementFunction::LAST_OFFSET - JSPromiseAnyRejectElementFunction::ERRORS_OFFSET}},
            ...
            {JSType::JS_PROXY, {JSProxy::TARGET_OFFSET, JSProxy::HANDLER_OFFSET, JSProxy::METHOD_OFFSET,
                                JSProxy::PRIVATE_FIELD_OFFSET, JSProxy::LAST_OFFSET - JSProxy::TARGET_OFFSET}},
            ...
            {JSType::JS_REG_EXP, {JSRegExp::REGEXP_BYTE_CODE_OFFSET, JSRegExp::ORIGINAL_SOURCE_OFFSET,
                                  ...
                                  JSRegExp::LAST_OFFSET - JSRegExp::REGEXP_BYTE_CODE_OFFSET}},
            {JSType::JS_REG_EXP_ITERATOR, {
                JSRegExpIterator::ITERATING_REGEXP_OFFSET,
                JSRegExpIterator::ITERATED_STRING_OFFSET,
                JSRegExpIterator::LAST_OFFSET - JSRegExpIterator::ITERATING_REGEXP_OFFSET}},
            ...
            {JSType::JS_SEGMENT_ITERATOR, {JSSegmentIterator::ICU_FIELD_OFFSET,
                                           ...
                                           JSSegmentIterator::LAST_OFFSET - JSSegmentIterator::ICU_FIELD_OFFSET}},
            ...
            {JSType::JS_SHARED_ARRAY, {JSSharedArray::TRACK_INFO_OFFSET,
                                       JSSharedArray::LAST_OFFSET - JSSharedArray::LENGTH_OFFSET}},
            ...
            {JSType::JS_SHARED_BIGINT64_ARRAY, {
                JSSharedTypedArray::LAST_OFFSET - JSSharedTypedArray::MOD_RECORD_OFFSET}},
            ...
            {JSType::JS_SHARED_MAP, {JSSharedMap::LINKED_MAP_OFFSET,
                                     JSSharedMap::LAST_OFFSET - JSSharedMap::LINKED_MAP_OFFSET}},
            ...
            {JSType::JS_SHARED_SET, {JSSharedSet::LINKED_SET_OFFSET,
                                     JSSharedSet::LAST_OFFSET - JSSharedSet::LINKED_SET_OFFSET}},
            ...
            {JSType::JS_STRING_ITERATOR, {
                ...
                JSStringIterator::LAST_OFFSET - JSStringIterator::ITERATED_STRING_OFFSET}},
            ...
            {JSType::LOCAL_EXPORTENTRY_RECORD, {
                ...
                LocalExportEntry::LAST_OFFSET - LocalExportEntry::LOCAL_EXPORT_ENTRY_OFFSET}},
            ...
            {JSType::PROTOTYPE_HANDLER, {PrototypeHandler::HANDLER_INFO_OFFSET,
                                         ...
                                         PrototypeHandler::LAST_OFFSET - PrototypeHandler::HANDLER_INFO_OFFSET}},
            ...
            {JSType::RB_TREENODE, {RBTreeNode::LEFT_OFFSET, RBTreeNode::RIGHT_OFFSET, RBTreeNode::ISRED_OFFSET,
                                   RBTreeNode::LAST_OFFSET - RBTreeNode::LEFT_OFFSET}},
            ...
            {JSType::RESOLVEDINDEXBINDING_RECORD, {
                ...
                ResolvedIndexBinding::END_OFFSET - ResolvedIndexBinding::MODULE_OFFSET}},
            ...
            {JSType::RESOLVEDRECORDINDEXBINDING_RECORD, {
                ...
                ResolvedRecordIndexBinding::END_OFFSET - ResolvedRecordIndexBinding::MODULE_RECORD_INDEX_OFFSET}},
        ...
        fieldSizeTable_ = {
            ...
            {JSType::IMPORTENTRY_RECORD, {
                ...
                ImportEntry::IMPORT_NAME_OFFSET - ImportEntry::MODULE_REQUEST_OFFSET,
                ImportEntry::SIZE - ImportEntry::IMPORT_NAME_OFFSET}},
            {JSType::INDIRECT_EXPORTENTRY_RECORD, {
                IndirectExportEntry::MODULE_REQUEST_OFFSET - IndirectExportEntry::INDIRECT_EXPORT_ENTRY_OFFSET,
                IndirectExportEntry::IMPORT_NAME_OFFSET - IndirectExportEntry::MODULE_REQUEST_OFFSET,
                IndirectExportEntry::SIZE - IndirectExportEntry::IMPORT_NAME_OFFSET}},
            ...
            {JSType::JS_FUNCTION, {
                ...
                JSFunction::PROTO_TRANS_ROOT_HCLASS_OFFSET - JSFunction::ECMA_MODULE_OFFSET,
                JSFunction::WORK_NODE_POINTER_OFFSET - JSFunction::PROTO_TRANS_ROOT_HCLASS_OFFSET}},
            ...
            {JSType::SOURCE_TEXT_MODULE_RECORD, {
                ...
                SourceTextModule::REQUESTED_MODULES_OFFSET - SourceTextModule::NAMESPACE_OFFSET,
