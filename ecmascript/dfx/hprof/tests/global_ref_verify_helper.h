...
#ifndef ECMASCRIPT_DFX_HPROF_TESTS_GLOBAL_REF_VERIFY_HELPER_H
#define ECMASCRIPT_DFX_HPROF_TESTS_GLOBAL_REF_VERIFY_HELPER_H
...
#endif  // ECMASCRIPT_DFX_HPROF_TESTS_GLOBAL_REF_VERIFY_HELPER_H
