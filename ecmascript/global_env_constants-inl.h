...
#define DECL_GET_IMPL_WITH_TYPE(Type, Name, Index, Desc) DECL_GET_IMPL_COMMON(Type, Name, Index)
    ...
    SHARED_PUBLIC_CONSTANT_SYMBOL(DECL_GET_IMPL_WITH_TYPE)        // NOLINT(readability-const-return-type)
    SHARED_DETECTOR_LISTS(DECL_GET_IMPL_STRING)                   // NOLINT(readability-const-return-type)
