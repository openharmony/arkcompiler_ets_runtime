...
private:
    struct LoadObjByNameDataInfo {
        LoadObjByNameDataInfo(std::vector<Label> &loaderLabels, std::vector<Label> &failLabels,
            const LoadObjByNameTypeInfoAccessor &ldTacc, Variable &resVar, Label &exitLabel) : loaders(loaderLabels),
        ...
        const LoadObjByNameTypeInfoAccessor &tacc;
        Variable &result;
        Label &exit;
    };
    ...
    void LoadOnPrototypeForHeapObjectReceiver(const LoadObjByNameTypeInfoAccessor &tacc, Variable &result,
                                              LoadObjByNameOnProtoTypeInfo ldProtoInfo);
    void LowerTypedMonoLdObjByNameOnProto(const LoadObjByNameTypeInfoAccessor &tacc, Variable &result);
    void LowerTypedMonoLdObjByName(const LoadObjByNameTypeInfoAccessor &tacc);
    void LowerTypedPolyLdObjByName(const LoadObjByNameTypeInfoAccessor &tacc);
