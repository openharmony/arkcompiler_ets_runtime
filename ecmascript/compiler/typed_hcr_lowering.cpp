...
GateRef TypedHCRLowering::VisitGate(GateRef gate)
{
    ...
    switch (op) {
        ...
        case OpCode::PRIMTYPE_PROTO_CHANGE_MARKER_CHECK:
            LowerPrimitiveTypeProtoChangeMarkerCheck(gate);
            break;
...
void TypedHCRLowering::LowerArrayConstructorCheck(GateRef gate, GateRef glue)
{
    ...
    builder_.Bind(&isHeapObject);
    {
        ...
        builder_.Bind(&isJSFunction);
        {
            ...
            GateRef arrayFunc =
                builder_.GetGlobalEnvValue(VariableType::JS_ANY(), globalEnv, GlobalEnv::ARRAY_FUNCTION_INDEX);
...
void TypedHCRLowering::LowerFloat32ArrayConstructorCheck(GateRef gate, GateRef glue)
{
    ...
    GateRef globalEnv = builder_.GetGlobalEnv(glue);
    GateRef arrayFunc =
        builder_.GetGlobalEnvValue(VariableType::JS_ANY(), globalEnv, GlobalEnv::FLOAT32_ARRAY_FUNCTION_INDEX);
...
void TypedHCRLowering::LowerObjectConstructorCheck(GateRef gate, GateRef glue)
{
    ...
    builder_.Bind(&isHeapObject);
    {
        ...
        builder_.Bind(&isJSFunction);
        {
            ...
            GateRef globalEnv = builder_.GetGlobalEnv(glue);
            GateRef targetFunc =
                builder_.GetGlobalEnvValue(VariableType::JS_ANY(), globalEnv, GlobalEnv::OBJECT_FUNCTION_INDEX);
...
void TypedHCRLowering::LowerBooleanConstructorCheck(GateRef gate, GateRef glue)
{
    ...
    builder_.Bind(&isHeapObject);
    {
        ...
        builder_.Bind(&isJSFunction);
        {
            ...
            GateRef globalEnv = builder_.GetGlobalEnv(glue);
            GateRef booleanFunc =
                builder_.GetGlobalEnvValue(VariableType::JS_ANY(), globalEnv, GlobalEnv::BOOLEAN_FUNCTION_INDEX);
...
void TypedHCRLowering::LowerPrimitiveTypeProtoChangeMarkerCheck(GateRef gate)
{
    Environment env(gate, circuit_, &builder_);
    GateRef frameState = acc_.GetFrameState(gate);
...
void TypedHCRLowering::LowerMonoLoadPropertyOnProto(GateRef gate)
{
    ...
    GetPropertyHolderFromProtoChain({ receiver, hclassIndex, unsharedConstPool, frameState },
...
void TypedHCRLowering::GetPropertyHolderFromProtoChain(
    ProtoTypeHolderInfo holderInfo, Label *loadHolder, Variable *current, DeoptType deoptType)
{
    ...
    auto receiverHC = builder_.LoadConstOffset(
        VariableType::JS_POINTER(), holderInfo.receiver, TaggedObject::HCLASS_OFFSET);
    *current = builder_.LoadConstOffset(VariableType::JS_ANY(), receiverHC, JSHClass::PROTOTYPE_OFFSET);
    ...
    auto curHC = builder_.LoadConstOffset(VariableType::JS_POINTER(),
                                          current->ReadVariable(), TaggedObject::HCLASS_OFFSET);
