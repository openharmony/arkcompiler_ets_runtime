...
GateRef StubBuilder::FindEntryFromNameDictionary(GateRef glue, GateRef elements, GateRef key, GateRef hir)
{
    ...
    LoopBegin(&loopHead);
    {
        GateRef element = GetKeyFromDictionary<NameDictionary>(glue, elements, *entry);
        Label isHole(env);
        Label notHole(env);
        BRANCH(TaggedIsHole(element), &isHole, &notHole);
        {
...
GateRef StubBuilder::LdGlobalRecord(GateRef glue, GateRef key)
{
    ...
    GateRef globalRecord = GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv, GlobalEnv::GLOBAL_RECORD);
                                       ...
                                       bool canUseIsInternal, GateRef hir)
{
    ...
    LoopBegin(&loopHead);
    {
        ...
        Bind(&isSIndexObj);
        {
            ...
            BRANCH(LogicAndBuilder(env).And(TaggedIsString(glue, holderValue)).And(TaggedIsString(glue, key)).Done(),
                &isString, &notString);
            Bind(&isString);
            {
                ...
                Bind(&getStringPrototype);
                {
                    GateRef glueGlobalEnvOffset = IntPtr(JSThread::GlueData::GetGlueGlobalEnvOffset(env->Is32Bit()));
                    GateRef glueGlobalEnv = LoadPrimitive(VariableType::NATIVE_POINTER(), glue, glueGlobalEnvOffset);
                    GateRef stringPrototype = GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv,
...
void StubBuilder::NotifyArrayPrototypeChangedGuardians(GateRef glue, GateRef receiver)
{
    ...
    GateRef guardians = LoadPrimitive(VariableType::BOOL(), glue, guardiansOffset);
    ...
    Bind(&isGuardians);
    {
        ...
        Bind(&isPrototype);
        {
            ...
            GateRef isEnvPrototypeCheck = LogicOrBuilder(env)
                .Or(Equal(GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv,
    ...
    GateRef glue, GateRef object, GateRef target, GateRef profileTypeInfo, GateRef slotId, ProfileOperation callback)
{
    ...
    Bind(&targetIsEcmaObject);
    {
        ...
        GateRef glueGlobalEnvOffset = IntPtr(JSThread::GlueData::GetGlueGlobalEnvOffset(env->Is32Bit()));
        GateRef glueGlobalEnv = LoadPrimitive(VariableType::NATIVE_POINTER(), glue, glueGlobalEnvOffset);
        GateRef hasInstanceSymbol = GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv,
...
GateRef StubBuilder::IsSimpleEnumCacheValid(GateRef glue, GateRef obj)
{
    ...
    Bind(&receiverHasNoElements);
    {
        ...
        LoopBegin(&loopHead);
        {
            ...
            GateRef protoEnumCache = GetEnumCacheFromHClass(glue, hclass);
...
GateRef StubBuilder::IsEnumCacheWithProtoChainInfoValid(GateRef glue, GateRef obj)
{
    ...
    BRANCH(Int32GreaterThan(numOfElements, Int32(0)), &exit, &receiverHasNoElements);
    Bind(&receiverHasNoElements);
    GateRef prototype = GetPrototypeFromHClass(glue, LoadHClass(glue, obj));
    BRANCH(IsEcmaObject(glue, prototype), &prototypeIsEcmaObj, &exit);
    Bind(&prototypeIsEcmaObj);
    GateRef protoChangeMarker = GetProtoChangeMarkerFromHClass(glue, LoadHClass(glue, prototype));
                                      ...
                                      Label *match, Label *slowPath, size_t index)
{
    ...
    GateRef glueGlobalEnvOffset = IntPtr(JSThread::GlueData::GetGlueGlobalEnvOffset(env->Is32Bit()));
    GateRef glueGlobalEnv = LoadPrimitive(VariableType::NATIVE_POINTER(), glue, glueGlobalEnvOffset);
    GateRef globalRecord = GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv, index);
...
GateRef StubBuilder::IsDetectorInvalid(GateRef glue, size_t indexDetector)
{
    ...
    GateRef glueGlobalEnvOffset = IntPtr(JSThread::GlueData::GetGlueGlobalEnvOffset(env->Is32Bit()));
    GateRef glueGlobalEnv = LoadPrimitive(VariableType::NATIVE_POINTER(), glue, glueGlobalEnvOffset);
    GateRef value = GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv, indexDetector);
...
GateRef StubBuilder::IsStableJSArguments(GateRef glue, GateRef obj)
{
    ...
    Bind(&targetIsHeapObject);
    {
        ...
        Bind(&targetIsStableArguments);
        {
            GateRef guardiansOffset =
                IntPtr(JSThread::GlueData::GetArrayElementsGuardiansOffset(env->Is32Bit()));
            result = LoadPrimitive(VariableType::BOOL(), glue, guardiansOffset);
            Jump(&exit);
        }
    }
    Bind(&exit);
...
GateRef StubBuilder::Loadlocalmodulevar(GateRef glue, GateRef index, GateRef module)
{
    ...
    Bind(&notSendableFunctionModule);
    {
        ...
        GateRef dictionary = Load(VariableType::JS_ANY(), glue, module, nameDictionaryOffset);
        ...
        Bind(&dataIsNotUndefined);
        {
            ...
            result = Load(VariableType::JS_ANY(), glue, dictionary, offset);
            Jump(&exit);
        }
    }
    Bind(&exit);
...
GateRef StubBuilder::GetElementsKindHClass(GateRef glue, GateRef elementKind)
{
    ...
    GateRef constantIdx = LoadPrimitive(VariableType::INT64(), arrayIndexes, offset);
...
GateRef StubBuilder::ToPrimitive(GateRef glue, GateRef value, PreferredPrimitiveType type, GateRef hir)
{
    ...
    Bind(&isEcmaObject);
    {
        ...
        GateRef glueGlobalEnvOffset = IntPtr(JSThread::GlueData::GetGlueGlobalEnvOffset(env->Is32Bit()));
        GateRef glueGlobalEnv = LoadPrimitive(VariableType::NATIVE_POINTER(), glue, glueGlobalEnvOffset);
        GateRef primitiveKey = GetGlobalEnvValue(VariableType::JS_ANY(), glue, glueGlobalEnv,
...
void StubBuilder::ComputeRawHashcode(Label *exit, Variable* result, StringInfoGateRef stringGate, bool isUtf8)
{
    auto env= GetEnvironment();
    Label loopHead(env);
    Label loopEnd(env);
    ...
    GateRef data = GetNormalStringData(stringGate);
    DEFVARIABLE(i, VariableType::INT32(), Int32(0));
    Jump(&loopHead);
    LoopBegin(&loopHead);
    {
...
GateRef StubBuilder::ComputeStringHashcode(GateRef glue, GateRef str)
{
    ...
    Bind(&isUtf8);
    {
        ComputeRawHashcode(&exit, &result, stringInfoGate, true);
    }
    Bind(&isUtf16);
    {
        ComputeRawHashcode(&exit, &result, stringInfoGate, false);
    }
    Bind(&exit);
    auto ret = *result;
    env->SubCfgExit();
