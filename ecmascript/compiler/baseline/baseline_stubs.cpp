...
void BaselineCallArg1Imm8V8StubBuilder::GenerateCircuit()
{
    ...
    CallStubBuilder callBuilder(this, glue, acc, actualNumArgs, jumpSize, &result, callArgs, callback);
...
void BaselineSupercallthisrangeImm8Imm8V8StubBuilder::GenerateCircuit()
{
    ...
    Bind(&fastPath);
    {
        ...
        Bind(&ctorNotBase);
        {
            ...
            CallStubBuilder callBuilder(this, glue, superCtor, actualNumArgs, jumpSize, &res, callArgs, callback);
            callBuilder.JSCallDispatchForBaseline(&exit, &noNeedCheckException);
            Bind(&exit);
            Jump(&threadCheck);
        }
...
void BaselineSupercallspreadImm8V8StubBuilder::GenerateCircuit()
{
    ...
    Bind(&normalPath);
    {
        ...
        Bind(&ctorNotBase);
        {
            ...
            CallStubBuilder callBuilder(this, glue, superCtor, argvLen, jumpSize, &res, callArgs, callback);
            callBuilder.JSCallDispatchForBaseline(&exit, &noNeedCheckException);
            Bind(&exit);
            Jump(&threadCheck);
        }
...
void BaselineResumegeneratorStubBuilder::GenerateCircuit()
{
    ...
    Label dispatch(env);
    Branch(TaggedIsAsyncGeneratorObject(glue, acc), &isAsyncGeneratorObj, &notAsyncGeneratorObj);
...
void BaselineWideNewobjrangePrefImm16V8StubBuilder::GenerateCircuit()
{
    ...
    Bind(&fastPath);
    {
        ...
        Bind(&ctorNotBase);
        {
            ...
            CallStubBuilder callBuilder(this, glue, ctor, actualNumArgs, jumpSize, &res, callArgs, callback);
            callBuilder.JSCallDispatchForBaseline(&exit, &noNeedCheckException);
            Bind(&exit);
            Jump(&threadCheck);
        }
...
void BaselineThrowIfnotobjectPrefV8StubBuilder::GenerateCircuit()
{
    ...
    Bind(&isHeapObject);
    Branch(TaggedObjectIsEcmaObject(glue, v0), &isEcmaObject, &notEcmaObject);
    Bind(&isEcmaObject);
    {
        Return();
    }
...
void BaselineDeprecatedCallarg0PrefV8StubBuilder::GenerateCircuit()
{
    ...
    callArgs.callArgs = { 0, 0, 0 };
    CallStubBuilder callBuilder(this, glue, func, actualNumArgs, jumpSize, &result, callArgs, callback);
    callBuilder.JSCallDispatchForBaseline(&exit, &noNeedCheckException);
    Bind(&exit);
    CHECK_PENDING_EXCEPTION(*result);
    Bind(&noNeedCheckException);
