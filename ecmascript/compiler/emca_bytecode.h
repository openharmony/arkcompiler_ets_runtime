...
#define ECMA_BYTECODE_LIST(V)  \
    ...
    V(DEFINENCFUNCDYN_PREF_ID16_IMM16_V8) \
    V(DEFINEGENERATORFUNC_PREF_ID16_IMM16_V8) \
    V(DEFINEASYNCFUNC_PREF_ID16_IMM16_V8) \
    ...
    V(ASYNCGENERATORREJECT_PREF_V8_V8) \
    V(DEFINEASYNCGENERATORFUNC_PREF_ID16_IMM16_V8) \
