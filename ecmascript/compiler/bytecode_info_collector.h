...
public:
    ...
    static void ProcessMethodForJIT(MethodLiteral *method, const JSPandaFile *jp);
private:
    ...
    static bool OpcodeSupprotFastCall(BytecodeInstruction::Opcode opcode);
    static bool OpcodeSupportTypeByteCall(BytecodeInstruction::Opcode opcode);
