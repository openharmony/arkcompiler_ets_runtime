...
// GateRef BuiltinsStringStubBuilder::CreateFromUtf16(GateRef glue, GateRef obj, GateRef length)
// {
//     auto env = GetEnvironment();
//     Label entry(env);
//     env->SubCfgEntry(&entry);
//     DEFVARIABLE(result, VariableType::JS_ANY(), Undefined());
//     DEFVARIABLE(src, VariableType::JS_ANY(), obj);
//     DEFVARIABLE(dst, VariableType::JS_ANY(), Undefined());
//     DEFVARIABLE(i, VariableType::INT32(), Int32(0));
//     Label exit(env);
//     Label afterNew(env);
//     NewObjectStubBuilder newBuilder(this);
//     newBuilder.SetParameters(glue, 0);
//     newBuilder.AllocLineStringObject(&result, &afterNew, length, false);
//     Bind(&afterNew);
//     {
//         dst = PtrAdd(*result, IntPtr(LineEcmaString::DATA_OFFSET));
...
//         LoopBegin(&loopHead);
//         {
//             Branch(Int32LessThan(*i, length), &next, &exit);
//             Bind(&next);
//             {
//                 Store(VariableType::INT16(), glue, *dst, IntPtr(0), *src);
//                 Jump(&loopEnd);
//             }
//         }
//         Bind(&loopEnd);
//         dst = PtrAdd(*dst, IntPtr(sizeof(uint16_t)));
//         src = PtrAdd(*src, IntPtr(sizeof(uint16_t)));
...
GateRef BuiltinsStringStubBuilder::CreateFromUtf16(GateRef glue, GateRef obj)
{
    auto env = GetEnvironment();
    Label entry(env);
    env->SubCfgEntry(&entry);
    ...
    NewObjectStubBuilder newBuilder(this);
    newBuilder.SetParameters(glue, 0);
    newBuilder.AllocLineStringObject(&result, &afterNew, Int32(2), false);
    Bind(&afterNew);
    {
        GateRef dst = PtrAdd(*result, IntPtr(LineEcmaString::DATA_OFFSET));
        Store(VariableType::INT16(), glue, dst, IntPtr(0), obj);
        Jump(&exit);
    }
    Bind(&exit);
    auto ret = *result;
