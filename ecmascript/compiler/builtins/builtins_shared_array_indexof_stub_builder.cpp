...
GateRef BuiltinsSharedArrayStubBuilder::MakeFromIndex(GateRef input, GateRef length, bool reversedOrder)
{
    ASM_ASSERT(GET_MESSAGE_STRING_ID(SharedArrayIndexOf), TaggedIsNumber(input));
...
GateRef BuiltinsSharedArrayStubBuilder::MakeFromIndexWithInt(GateRef intValue, GateRef length, bool reversedOrder)
{
    auto env = GetEnvironment();
    Label entry(env);
    env->SubCfgEntry(&entry);
...
GateRef BuiltinsSharedArrayStubBuilder::MakeFromIndexWithDouble(GateRef doubleValue, GateRef length, bool reversedOrder)
{
    auto env = GetEnvironment();
    Label entry(env);
    env->SubCfgEntry(&entry);
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfTaggedUndefined(
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfElements(
...
Variable BuiltinsSharedArrayStubBuilder::MakeResultVariableDefaultNotFound(IndexOfOptions options)
{
    VariableType type;
    GateRef value;
    switch (options.returnType) {
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfTaggedIntElements(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
    ...
    ASM_ASSERT(GET_MESSAGE_STRING_ID(SharedArrayIndexOf), BoolNot(TaggedIsUndefined(target)));
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfTaggedNumber(
    ...
    IndexOfOptions options, bool targetIsAlwaysDouble)
{
    if (targetIsAlwaysDouble) {
        ...
        ASM_ASSERT(GET_MESSAGE_STRING_ID(SharedArrayIndexOf), TaggedIsDouble(target));
    } else {
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfStringElements(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len,
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfBigIntOrObjectElements(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfGeneric(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
    ASM_ASSERT(GET_MESSAGE_STRING_ID(SharedArrayIndexOf), BoolNot(TaggedIsUndefined(target)));
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfTaggedZero(
    GateRef glue, GateRef elements, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
    auto env = GetEnvironment();
...
GateRef BuiltinsSharedArrayStubBuilder::StringEqual(
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfBigInt(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfObject(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfTaggedIntTarget(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfStringTarget(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
...
GateRef BuiltinsSharedArrayStubBuilder::IndexOfBigIntOrObjectTarget(
    GateRef glue, GateRef elements, GateRef target, GateRef fromIndex, GateRef len, IndexOfOptions options)
{
    auto env = GetEnvironment();
    Label entry(env);
...
GateRef BuiltinsSharedArrayStubBuilder::BigIntEqual(GateRef glue, GateRef left, GateRef right)
{
    auto env = GetEnvironment();
    Label entry(env);
    env->SubCfgEntry(&entry);
