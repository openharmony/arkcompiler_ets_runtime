...
inline GateRef StubBuilder::LoadPrimitive(VariableType type, GateRef base)
{
...
inline GateRef StubBuilder::GetGlobalObject(GateRef glue)
{
    ...
    // globalObject is not GC root but is nonmovable, so ReadBarrier is not needed
    return LoadPrimitive(VariableType::JS_ANY(), glue, offset);
}
...
inline GateRef StubBuilder::GetPropertiesCache(GateRef glue)
{
    ...
    GateRef currentContext = LoadPrimitive(VariableType::NATIVE_POINTER(), glue, currentContextOffset);
    GateRef propertiesCacheOffset = IntPtr(EcmaContext::EcmaData::GetPropertiesCacheOffset(env_->Is32Bit()));
    return LoadPrimitive(VariableType::NATIVE_POINTER(), currentContext, propertiesCacheOffset);
}
...
inline GateRef StubBuilder::GetMegaICCache(GateRef glue, MegaICCache::MegaICKind kind)
{
    ...
    return LoadPrimitive(VariableType::NATIVE_POINTER(), currentContext, megaICCache_Offset);
}
...
inline void StubBuilder::IncMegaProbeCount([[maybe_unused]]GateRef glue)
{
    ...
    GateRef before = LoadPrimitive(VariableType::INT64(), currentContext, megaProbeCountOffset);
...
inline void StubBuilder::IncMegaHitCount([[maybe_unused]]GateRef glue)
{
    ...
    GateRef before = LoadPrimitive(VariableType::INT64(), currentContext, megaHitCountOffset);
