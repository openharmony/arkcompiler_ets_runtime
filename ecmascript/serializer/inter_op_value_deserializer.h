...
struct XRefBindingAttachInfo {
    ...
    XRefBindingAttachInfo(AttachXRefFunc af, void *attachXRefData, JSHandle<JSTaggedValue> obj, size_t offset,
                          bool root)
        : af_(af), attachXRefData_(attachXRefData), obj_(obj), offset_(offset), root_(root) {}
...
private:
    size_t DerivedExtraReadSingleEncodeData(uint8_t encodeFlag, uintptr_t objAddr, size_t fieldOffset,
