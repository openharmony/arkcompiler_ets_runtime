...
function call_compiled_constructor_arguments_length_2(
    ...args: number[]): CallCompiledConstructorArgumentsLengthBox {
...
print(call_compiled_constructor_arguments_length_2(4, 5).len);
