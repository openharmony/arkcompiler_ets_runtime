 ...
 */
function call_compiled_function_via_call_arguments_sum_impl(this: { bias: number }) {
    let sum = this.bias;
...
function call_compiled_function_via_call_arguments_sum() {
    call_compiled_function_via_call_arguments_sum_impl.call({ bias: 1 }, 2, 3, 4);
