 ...
 */
class CallCompiledConstructorArgumentsLengthBox {
    len: number;
...
function call_compiled_constructor_arguments_length_1(): void {
    print(new CallCompiledConstructorArgumentsLengthBox().len);
    print(new CallCompiledConstructorArgumentsLengthBox(4).len);
