 ...
 */
class CallFunctionViaCallArgumentsMethodHolder {
    base: number;
...
function call_compiled_function_via_call_arguments_method() {
    print(CallFunctionViaCallArgumentsMethodHolder.prototype.collect.call({ base: 3 }, 4, 5));
