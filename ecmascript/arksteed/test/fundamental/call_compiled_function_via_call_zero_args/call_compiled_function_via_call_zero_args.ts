 ...
 */
function call_compiled_function_via_call_zero_args_impl(this: { value: number }): number {
    return this.value;
}

function call_compiled_function_via_call_zero_args() {
    print(call_compiled_function_via_call_zero_args_impl.call({ value: 42 }));
