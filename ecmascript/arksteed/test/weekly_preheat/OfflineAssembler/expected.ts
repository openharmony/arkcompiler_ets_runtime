...
export let expectedASTDumpedAsLines = [
  ...
  '    addp advance, PC', '    jumpToInstruction()',
  'end',
  'macro dispatchInt(advance)',
  '    addi advance, PC',
  '    jumpToInstruction()', 'end',
  'macro dispatchIntIndirect(offset)',
  '    dispatchInt((offset * 8)[PB, PC, 8])', 'end',
  'macro dispatchAfterCall()',
  '    loadi (ArgumentCount + TagOffset)[cfr], PC',
  '    loadp CodeBlock[cfr], PB',
  '    loadp CodeBlock::m_instructions[PB], PB', '    loadisFromInstruction(1, t1)',
  '    storeq r0, 0[cfr, t1, 8]',
  '    valueProfile(r0, (CallOpCodeSize - 1), t3)',
  '    dispatch(CallOpCodeSize)',
  'end', 'macro cCall2(function)',
  ...
  '    move a1, a2',
  '    move a0, a1',
  '    subp 48, sp', '    move sp, a0',
  '    addp 32, a0',
  '    call function',
  '    addp 48, sp', '    move 8[r0], r1',
  '    move 0[r0], r0',
  'else',
  'if C_LOOP',
  ...
  '    call function',
  '    addp 32, sp',
  'else', '    cCall2(function)',
  'end',
  'end',
  'end',
  'macro cCall4(function)', '    checkStackPointerAlignment(t4, 3134242820)',
  'if (X86_64 or ARM64)',
  '    call function',
  'else', 'if X86_64_WIN',
  '    subp 64, sp',
  ...
  '    functionPrologue()',
  '    pushCalleeSaves()',
  'const entry = a0', 'const vm = a1',
  'const protoCallFrame = a2',
  '    vmEntryRecord(cfr, sp)',
  '    checkStackPointerAlignment(t4, 3134249985)', '    storep vm, VMEntryRecord::m_vm[sp]',
  '    loadp VM::topCallFrame[vm], t4',
  '    storep t4, VMEntryRecord::m_prevTopCallFrame[sp]',
  '    loadp VM::topVMEntryFrame[vm], t4',
  '    storep t4, VMEntryRecord::m_prevTopVMEntryFrame[sp]',
  '    loadi ProtoCallFrame::paddedArgCount[protoCallFrame], t4', '    addp CallFrameHeaderSlots, t4, t4',
  '    lshiftp 3, t4',
  '    subp sp, t4, t3',
  '    bqbeq sp, t3, .throwStackOverflow', 'if C_LOOP',
  ...
  '    bpeq t0, 0, .stackCheckFailed', '    move t4, entry',
  '    move t5, vm',
  '    jmp .stackHeightOK',
  '.stackCheckFailed:',
  '    move t4, entry', '    move t5, vm',
  'else',
  '    skip',
  'end',
  '.throwStackOverflow:', '    move vm, a0',
  '    move protoCallFrame, a1',
  '    cCall2(_llint_throw_stack_overflow_error)',
  '    vmEntryRecord(cfr, t4)', '    loadp VMEntryRecord::m_vm[t4], vm',
  ...
  '    storep extraTempReg, VM::topVMEntryFrame[vm]', '    subp cfr, CalleeRegisterSaveSize, sp',
  '    popCalleeSaves()',
  '    functionEpilogue()',
  '    ret ', '.stackHeightOK:',
  '    move t3, sp',
  ...
  '    addp 16, sp',
  'if C_LOOP',
  '    cloopCallJSFunction entry', 'else',
  '    call entry',
  'end',
  '    subp 16, sp', 'end',
  ...
  'end',
  'end',
  '_handleUncaughtException:', '    loadp Callee[cfr], t3',
  '    andp MarkedBlockMask, t3',
  '    loadp MarkedBlock::m_vm[t3], t3',
  '    restoreCalleeSavesFromVMEntryFrameCalleeSavesBuffer(t3, t0)',
  '    loadp VM::callFrameForCatch[t3], cfr', '    storep 0, VM::callFrameForCatch[t3]',
  '    loadp CallerFrame[cfr], cfr',
  '    vmEntryRecord(cfr, t2)', '    loadp VMEntryRecord::m_vm[t2], t3',
  ...
  '    subp cfr, CalleeRegisterSaveSize, sp', '    popCalleeSaves()',
  '    functionEpilogue()',
  '    ret ',
  'macro prepareStateForCCall()',
  '    leap 0[PB, PC, 8], PC', 'end',
  ...
  '    move cfr, a0',
  '    move PC, a1',
  '    cCall2(slowPath)', '    restoreStateAfterCCall()',
  'end',
  'macro traceOperand(fromWhere, operand)',
  '    prepareStateForCCall()',
  '    move fromWhere, a2',
  '    move operand, a3', '    move cfr, a0',
  '    move PC, a1',
  '    cCall4(_llint_trace_operand)',
  '    restoreStateAfterCCall()', 'end',
  ...
  '    prepareStateForCCall()', '    move cfr, a0',
  '    move PC, a1',
  '    cCall2(slowPath)',
  '    action(r0, r1)', 'end',
  'macro callTrapHandler(throwHandler)',
  '    storei PC, (ArgumentCount + TagOffset)[cfr]', '    prepareStateForCCall()',
  '    move cfr, a0',
  '    move PC, a1',
  '    cCall2(_llint_slow_path_handle_traps)', '    btpnz r0, throwHandler',
  '    loadi (ArgumentCount + TagOffset)[cfr], PC',
  'end', 'macro checkSwitchToJITForLoop()',
  '    checkSwitchToJIT(1, macro ()',
  '    storei PC, (ArgumentCount + TagOffset)[cfr]',
  '    prepareStateForCCall()', '    move cfr, a0',
  '    move PC, a1',
  '    cCall2(_llint_loop_osr)', '    btpz r0, .recover',
  '    move r1, sp',
  '    jmp r0', '.recover:',
  '    loadi (ArgumentCount + TagOffset)[cfr], PC',
  'end)', 'end', 'macro loadCaged(basePtr, source, dest, scratch)',
  '    loadp source, dest',
  'if (GIGACAGE_ENABLED and (notC_LOOP))',
  '    loadp basePtr, scratch', '    btpz scratch, .done',
  '    andp constexpr (GIGACAGE_MASK), dest',
  '    addp scratch, dest', '.done:',
  'else',
  '    skip',
  'end', 'end',
  ...
  'end', 'macro loadConstantOrVariable(index, value)',
  ...
  '    writeBarrierOnGlobal(valueOperand, macro (registerToStoreGlobal)',
  '    loadp CodeBlock[cfr], registerToStoreGlobal',
  '    loadp CodeBlock::m_globalObject[registerToStoreGlobal]\,' +
    ' registerToStoreGlobal',
  '    loadp JSGlobalObject::m_globalLexicalEnvironment[registerToStoreGlobal], registerToStoreGlobal',
  'end)',
  'end', 'macro valueProfile(value, operand, scratch)',
  '    loadpFromInstruction(operand, scratch)',
  '    storeq value, ValueProfile::m_buckets[scratch]',
  'end', 'macro structureIDToStructureWithScratch(structureIDThenStructure, scratch)',
  ...
  'end', 'macro loadStructureWithScratch(cell, structure, scratch)',
  '    loadi JSCell::m_structureID[cell], structure',
  '    structureIDToStructureWithScratch(structure, scratch)',
  'end', 'macro loadStructureAndClobberFirstArg(cell, structure)',
  '    loadi JSCell::m_structureID[cell], structure',
  '    loadp CodeBlock[cfr], cell', '    loadp CodeBlock::m_vm[cell], cell',
  ...
  '    prepareStateForCCall()',
  '    move cfr, a0', '    move PC, a1',
  '    cCall2(slowPath)',
  '    btiz r0, .noError',
  '    move r1, cfr', '    jmp _llint_throw_from_slow_path_trampoline',
  '.noError:',
  '    loadi CommonSlowPaths::ArityCheckData::paddedStackSpace[r1], t1',
  '    btiz t1, .continue',
  '    loadi (PayloadOffset + ArgumentCount)[cfr], t2',
  '    addi CallFrameHeaderSlots, t2', '    move t1, t3',
  '    andi (StackAlignmentSlots - 1), t3',
  '    btiz t3, .noExtraSlot',
  '    move ValueUndefined, t0',
  '.fillExtraSlots:', '    storeq t0, 0[cfr, t2, 8]',
  '    addi 1, t2',
  '    bsubinz 1, t3, .fillExtraSlots',
  '    andi (~(StackAlignmentSlots - 1)), t1',
  '    btiz t1, .continue', '.noExtraSlot:',
  '    negq t1',
  '    move cfr, t3',
  '    subp (CalleeSaveSpaceAsVirtualRegisters * 8), t3',
  '    addi CalleeSaveSpaceAsVirtualRegisters, t2',
  '    move t1, t0', '    lshiftp 3, t0',
  '    addp t0, cfr',
  '    addp t0, sp',
  '.copyLoop:',
  '    loadq 0[t3], t0', '    storeq t0, 0[t3, t1, 8]',
  '    addp 8, t3',
  '    bsubinz 1, t2, .copyLoop',
  '    move t1, t2',
  '    move ValueUndefined, t0',
  '.fillLoop:', '    storeq t0, 0[t3, t1, 8]',
  '    addp 8, t3',
  '    baddinz 1, t2, .fillLoop',
  '.continue:',
  '    loadp CodeBlock[cfr], t1', '    loadp CodeBlock::m_instructions[t1], PB',
  '    move 0, PC',
  '    jmp doneLabel',
  'end',
  'macro branchIfException(label)',
  '    loadp Callee[cfr], t3', '    andp MarkedBlockMask, t3',
  '    loadp MarkedBlock::m_vm[t3], t3',
  '    btqz VM::m_exception[t3], .noException',
  '    jmp label', '.noException:',
  'end',
  '_llint_op_enter:',
  '    traceExecution()',
  '    checkStackPointerAlignment(t2, 3735879905)', '    loadp CodeBlock[cfr], t2',
  '    loadi CodeBlock::m_numVars[t2], t2',
  '    subq CalleeSaveSpaceAsVirtualRegisters, t2',
  '    move cfr, t1', '    subq (CalleeSaveSpaceAsVirtualRegisters * 8), t1',
  '    btiz t2, .opEnterDone',
  '    move ValueUndefined, t0',
  '    negi t2',
  '    sxi2q t2, t2', '.opEnterLoop:',
  '    storeq t0, 0[t1, t2, 8]',
  '    addq 1, t2',
  '    btqnz t2, .opEnterLoop', '.opEnterDone:',
  '    callOpcodeSlowPath(_slow_path_enter)',
  '    dispatch(constexpr (op_enter_length))',
  '_llint_op_get_argument:', '    traceExecution()',
  '    loadisFromInstruction(1, t1)',
  '    loadisFromInstruction(2, t2)',
  '    loadi (PayloadOffset + ArgumentCount)[cfr], t0',
  '    bilteq t0, t2, .opGetArgumentOutOfBounds', '    loadq ThisArgumentOffset[cfr, t2, 8], t0',
  '    storeq t0, 0[cfr, t1, 8]',
  '    valueProfile(t0, 3, t2)',
  '    dispatch(constexpr (op_get_argument_length))', '.opGetArgumentOutOfBounds:',
  '    storeq ValueUndefined, 0[cfr, t1, 8]',
  '    valueProfile(ValueUndefined, 3, t2)',
  '    dispatch(constexpr (op_get_argument_length))', '_llint_op_argument_count:',
  '    traceExecution()',
  '    loadisFromInstruction(1, t1)',
  '    loadi (PayloadOffset + ArgumentCount)[cfr], t0', '    subi 1, t0',
  '    orq TagTypeNumber, t0',
  '    storeq t0, 0[cfr, t1, 8]',
  '    dispatch(constexpr (op_argument_count_length))',
  '_llint_op_get_scope:', '    traceExecution()',
  '    loadp Callee[cfr], t0',
  '    loadp JSCallee::m_scope[t0], t0',
  '    loadisFromInstruction(1, t1)',
  '    storeq t0, 0[cfr, t1, 8]', '    dispatch(constexpr (op_get_scope_length))',
  '_llint_op_to_this:',
  '    traceExecution()',
  '    loadisFromInstruction(1, t0)',
  '    loadq 0[cfr, t0, 8], t0', '    btqnz t0, tagMask, .opToThisSlow',
  '    bbneq JSCell::m_type[t0], FinalObjectType, .opToThisSlow',
  '    loadStructureWithScratch(t0, t1, t2)',
  '    loadpFromInstruction(2, t2)', '    bpneq t1, t2, .opToThisSlow',
  '    dispatch(constexpr (op_to_this_length))',
  '.opToThisSlow:',
  '    callOpcodeSlowPath(_slow_path_to_this)', '    dispatch(constexpr (op_to_this_length))',
  '_llint_op_check_tdz:',
  '    traceExecution()',
  '    loadisFromInstruction(1, t0)',
  '    loadConstantOrVariable(t0, t1)', '    bqneq t1, ValueEmpty, .opNotTDZ',
  '    callOpcodeSlowPath(_slow_path_throw_tdz_error)',
  '.opNotTDZ:',
  '    dispatch(constexpr (op_check_tdz_length))',
  '_llint_op_mov:', '    traceExecution()',
  '    loadisFromInstruction(2, t1)',
  '    loadisFromInstruction(1, t0)',
  '    loadConstantOrVariable(t1, t2)',
  '    storeq t2, 0[cfr, t0, 8]', '    dispatch(constexpr (op_mov_length))',
  '_llint_op_not:',
  '    traceExecution()',
  '    loadisFromInstruction(2, t0)',
  '    loadisFromInstruction(1, t1)',
  '    loadConstantOrVariable(t0, t2)', '    xorq ValueFalse, t2',
  '    btqnz t2, (~1), .opNotSlow',
  '    xorq ValueTrue, t2',
  '    storeq t2, 0[cfr, t1, 8]', '    dispatch(constexpr (op_not_length))',
  '.opNotSlow:',
  '    callOpcodeSlowPath(_slow_path_not)',
  '    dispatch(constexpr (op_not_length))',
  'macro equalityComparison(integerComparison, slowPath)', '    traceExecution()',
  '    loadisFromInstruction(3, t0)',
  '    loadisFromInstruction(2, t2)', '    loadisFromInstruction(1, t3)',
  '    loadConstantOrVariableInt32(t0, t1, .slow)',
  '    loadConstantOrVariableInt32(t2, t0, .slow)',
  '    integerComparison(t0, t1, t0)',
  '    orq ValueFalse, t0', '    storeq t0, 0[cfr, t3, 8]',
  '    dispatch(4)',
  '.slow:',
  ...
  'end, _slow_path_eq)',
  '_llint_op_neq:',
  '    equalityComparison(macro (left, right, result)', '    cineq left, right, result',
  'end, _slow_path_neq)',
  'macro equalNullComparison()',
  '    loadisFromInstruction(2, t0)',
  '    loadq 0[cfr, t0, 8], t0', '    btqnz t0, tagMask, .immediate',
  '    btbnz JSCell::m_flags[t0], MasqueradesAsUndefined, .masqueradesAsUndefined',
  '    move 0, t0', '    jmp .done',
  '.masqueradesAsUndefined:',
  '    loadStructureWithScratch(t0, t2, t1)',
  '    loadp CodeBlock[cfr], t0',
  '    loadp CodeBlock::m_globalObject[t0], t0', '    cpeq Structure::m_globalObject[t2], t0, t0',
  '    jmp .done',
  '.immediate:',
  ...
  '    equalNullComparison()',
  '    loadisFromInstruction(1, t1)',
  '    orq ValueFalse, t0', '    storeq t0, 0[cfr, t1, 8]',
  '    dispatch(constexpr (op_eq_null_length))',
  '_llint_op_neq_null:',
  '    traceExecution()',
  '    equalNullComparison()', '    loadisFromInstruction(1, t1)',
  '    xorq ValueTrue, t0',
  '    storeq t0, 0[cfr, t1, 8]', '    dispatch(constexpr (op_neq_null_length))',
  'macro strictEq(equalityOperation, slowPath)',
  '    traceExecution()',
  '    loadisFromInstruction(3, t0)',
  '    loadisFromInstruction(2, t2)', '    loadConstantOrVariable(t0, t1)',
  '    loadConstantOrVariable(t2, t0)',
  '    move t0, t2',
  '    orq t1, t2', '    btqz t2, tagMask, .slow',
  '    bqaeq t0, tagTypeNumber, .leftOK',
  '    btqnz t0, tagTypeNumber, .slow',
  '.leftOK:', '    bqaeq t1, tagTypeNumber, .rightOK',
  '    btqnz t1, tagTypeNumber, .slow',
  '.rightOK:',
  '    equalityOperation(t0, t1, t0)',
  '    loadisFromInstruction(1, t1)', '    orq ValueFalse, t0',
  '    storeq t0, 0[cfr, t1, 8]',
  '    dispatch(4)',
  '.slow:',
  '    callOpcodeSlowPath(slowPath)', '    dispatch(4)',
  'end',
  '_llint_op_stricteq:',
  '    strictEq(macro (left, right, result)',
  '    cqeq left, right, result', 'end, _slow_path_stricteq)',
  '_llint_op_nstricteq:',
  '    strictEq(macro (left, right, result)',
  '    cqneq left, right, result', 'end, _slow_path_nstricteq)',
  'macro preOp(arithmeticOperation, slowPath)',
  '    traceExecution()',
  '    loadisFromInstruction(1, t0)',
  '    loadq 0[cfr, t0, 8], t1', '    bqb t1, tagTypeNumber, .slow',
  '    arithmeticOperation(t1, .slow)',
  '    orq tagTypeNumber, t1',
  '    storeq t1, 0[cfr, t0, 8]', '    dispatch(2)',
  '.slow:',
  '    callOpcodeSlowPath(slowPath)',
  '    dispatch(2)',
  'end', '_llint_op_inc:',
  ...
  '    bqb t1, tagTypeNumber, .op2NotInt', '    loadisFromInstruction(1, t2)',
  '    integerOperationAndStore(t1, t0, .slow, t2)',
  '    loadisFromInstruction(4, t1)',
  '    ori ArithProfileIntInt, t1', '    storeisToInstruction(t1, 4)',
  '    dispatch(5)',
  '.op1NotInt:',
  '    btqz t0, tagTypeNumber, .slow',
  '    bqaeq t1, tagTypeNumber, .op1NotIntOp2Int', '    btqz t1, tagTypeNumber, .slow',
  '    addq tagTypeNumber, t1',
  '    fq2d t1, ft1',
  '    loadisFromInstruction(4, t2)', '    ori ArithProfileNumberNumber, t2',
  '    storeisToInstruction(t2, 4)',
  '    jmp .op1NotIntReady',
  '.op1NotIntOp2Int:', '    loadisFromInstruction(4, t2)',
  '    ori ArithProfileNumberInt, t2',
  '    storeisToInstruction(t2, 4)',
  '    ci2d t1, ft1',
  '.op1NotIntReady:', '    loadisFromInstruction(1, t2)',
  '    addq tagTypeNumber, t0',
  '    fq2d t0, ft0',
  '    doubleOperation(ft1, ft0)',
  '    fd2q ft0, t0', '    subq tagTypeNumber, t0',
  '    storeq t0, 0[cfr, t2, 8]',
  '    dispatch(5)',
  '.op2NotInt:', '    loadisFromInstruction(1, t2)',
  '    btqz t1, tagTypeNumber, .slow',
  '    loadisFromInstruction(4, t3)',
  '    ori ArithProfileIntNumber, t3',
  '    storeisToInstruction(t3, 4)', '    ci2d t0, ft0',
  '    addq tagTypeNumber, t1',
  '    fq2d t1, ft1',
  '    doubleOperation(ft1, ft0)',
  '    fd2q ft0, t0', '    subq tagTypeNumber, t0',
  ...
  '    dispatch(5)',
  '.slow:',
  '    callOpcodeSlowPath(slowPath)', '    dispatch(5)',
  'end', 'macro binaryOp(integerOperation, doubleOperation, slowPath)',
  ...
  'end, doubleOperation, slowPath)', 'end',
  '_llint_op_add:',
  '    traceExecution()',
  '    binaryOp(macro (left, right, slow)',
  '    baddio left, right, slow', 'end, macro (left, right)',
  '    addd left, right',
  'end, _slow_path_add)',
  '_llint_op_mul:',
  '    traceExecution()',
  '    binaryOpCustomStore(macro (left, right, slow, index)', '    move right, t3',
  '    bmulio left, t3, slow',
  '    btinz t3, .done',
  '    bilt left, 0, slow',
  '    bilt right, 0, slow', '.done:',
  '    orq tagTypeNumber, t3',
  '    storeq t3, 0[cfr, index, 8]',
  'end, macro (left, right)',
  '    muld left, right', 'end, _slow_path_mul)',
  '_llint_op_sub:',
  '    traceExecution()',
  '    binaryOp(macro (left, right, slow)',
  '    bsubio left, right, slow', 'end, macro (left, right)',
  '    subd left, right',
  'end, _slow_path_sub)',
  '_llint_op_div:', '    traceExecution()',
  'if (X86_64 or X86_64_WIN)',
  '    binaryOpCustomStore(macro (left, right, slow, index)',
  '    btiz left, slow', '    bineq left, (-1), .notNeg2TwoThe31DivByNeg1',
  '    bieq right, (-2147483648), .slow',
  '.notNeg2TwoThe31DivByNeg1:',
  '    btinz right, .intOK', '    bilt left, 0, slow',
  '.intOK:',
  '    move left, t3',
  '    move right, t0', '    cdqi ',
  '    idivi t3',
  '    btinz t1, slow',
  '    orq tagTypeNumber, t0', '    storeq t0, 0[cfr, index, 8]',
  'end, macro (left, right)',
  '    divd left, right',
  'end, _slow_path_div)', 'else',
  '    callOpcodeSlowPath(_slow_path_div)',
  '    dispatch(constexpr (op_div_length))',
  'end', 'macro bitOp(operation, slowPath, advance)',
  '    loadisFromInstruction(3, t0)',
  '    loadisFromInstruction(2, t2)',
  '    loadisFromInstruction(1, t3)', '    loadConstantOrVariable(t0, t1)',
  '    loadConstantOrVariable(t2, t0)',
  '    bqb t0, tagTypeNumber, .slow',
  '    bqb t1, tagTypeNumber, .slow', '    operation(t1, t0)',
  '    orq tagTypeNumber, t0',
  '    storeq t0, 0[cfr, t3, 8]',
  '    dispatch(advance)', '.slow:',
  '    callOpcodeSlowPath(slowPath)',
  '    dispatch(advance)',
  'end', '_llint_op_lshift:',
  '    traceExecution()',
  '    bitOp(macro (left, right)',
  '    lshifti left, right',
  'end, _slow_path_lshift, constexpr (op_lshift_length))',
  '_llint_op_rshift:', '    traceExecution()',
  '    bitOp(macro (left, right)',
  '    rshifti left, right',
  'end, _slow_path_rshift, constexpr (op_rshift_length))',
  '_llint_op_urshift:', '    traceExecution()',
  '    bitOp(macro (left, right)',
  '    urshifti left, right',
  'end, _slow_path_urshift, constexpr (op_urshift_length))',
  '_llint_op_unsigned:', '    traceExecution()',
  '    loadisFromInstruction(1, t0)',
  '    loadisFromInstruction(2, t1)',
  '    loadConstantOrVariable(t1, t2)',
  '    bilt t2, 0, .opUnsignedSlow', '    storeq t2, 0[cfr, t0, 8]',
  '    dispatch(constexpr (op_unsigned_length))',
  '.opUnsignedSlow:', '    callOpcodeSlowPath(_slow_path_unsigned)',
  '    dispatch(constexpr (op_unsigned_length))',
  '_llint_op_bitand:',
  '    traceExecution()',
  '    bitOp(macro (left, right)', '    andi left, right',
  'end, _slow_path_bitand, constexpr (op_bitand_length))',
  '_llint_op_bitxor:',
  '    traceExecution()',
  '    bitOp(macro (left, right)', '    xori left, right',
  'end, _slow_path_bitxor, constexpr (op_bitxor_length))',
  '_llint_op_bitor:',
  '    traceExecution()',
  '    bitOp(macro (left, right)', '    ori left, right',
  'end, _slow_path_bitor, constexpr (op_bitor_length))',
  '_llint_op_overrides_has_instance:',
  '    traceExecution()', '    loadisFromInstruction(1, t3)',
  '    loadisFromInstruction(3, t1)',
  '    loadConstantOrVariable(t1, t0)',
  '    loadp CodeBlock[cfr], t2', '    loadp CodeBlock::m_globalObject[t2], t2',
  '    loadp JSGlobalObject::m_functionProtoHasInstanceSymbolFunction[t2], t2',
  '    bqneq t0, t2, .opOverridesHasInstanceNotDefaultSymbol',
  '    loadisFromInstruction(2, t1)', '    loadConstantOrVariable(t1, t0)',
  '    tbz JSCell::m_flags[t0], ImplementsDefaultHasInstance, t1',
  '    orq ValueFalse, t1', '    storeq t1, 0[cfr, t3, 8]',
  '    dispatch(constexpr (op_overrides_has_instance_length))',
  '.opOverridesHasInstanceNotDefaultSymbol:',
  '    storeq ValueTrue, 0[cfr, t3, 8]',
  '    dispatch(constexpr (op_overrides_has_instance_length))',
  '_llint_op_instanceof_custom:', '    traceExecution()',
  '    callOpcodeSlowPath(_llint_slow_path_instanceof_custom)',
  '    dispatch(constexpr (op_instanceof_custom_length))',
  '_llint_op_is_empty:', '    traceExecution()',
  '    loadisFromInstruction(2, t1)',
  '    loadisFromInstruction(1, t2)',
  '    loadConstantOrVariable(t1, t0)',
  '    cqeq t0, ValueEmpty, t3', '    orq ValueFalse, t3',
  '    storeq t3, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_empty_length))',
  '_llint_op_is_undefined:', '    traceExecution()',
  '    loadisFromInstruction(2, t1)',
  '    loadisFromInstruction(1, t2)',
  '    loadConstantOrVariable(t1, t0)',
  '    btqz t0, tagMask, .opIsUndefinedCell', '    cqeq t0, ValueUndefined, t3',
  '    orq ValueFalse, t3',
  '    storeq t3, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_undefined_length))', '.opIsUndefinedCell:',
  '    btbnz JSCell::m_flags[t0], MasqueradesAsUndefined, .masqueradesAsUndefined',
  '    move ValueFalse, t1',
  '    storeq t1, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_undefined_length))', '.masqueradesAsUndefined:',
  '    loadStructureWithScratch(t0, t3, t1)',
  '    loadp CodeBlock[cfr], t1',
  '    loadp CodeBlock::m_globalObject[t1], t1',
  '    cpeq Structure::m_globalObject[t3], t1, t0', '    orq ValueFalse, t0',
  '    storeq t0, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_undefined_length))',
  '_llint_op_is_boolean:', '    traceExecution()',
  '    loadisFromInstruction(2, t1)',
  '    loadisFromInstruction(1, t2)',
  '    loadConstantOrVariable(t1, t0)',
  '    xorq ValueFalse, t0', '    tqz t0, (~1), t0',
  '    orq ValueFalse, t0',
  '    storeq t0, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_boolean_length))',
  '_llint_op_is_number:', '    traceExecution()',
  '    loadisFromInstruction(2, t1)',
  '    loadisFromInstruction(1, t2)',
  '    loadConstantOrVariable(t1, t0)',
  '    tqnz t0, tagTypeNumber, t1', '    orq ValueFalse, t1',
  '    storeq t1, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_number_length))',
  '_llint_op_is_cell_with_type:', '    traceExecution()',
  '    loadisFromInstruction(3, t0)',
  '    loadisFromInstruction(2, t1)',
  '    loadisFromInstruction(1, t2)',
  '    loadConstantOrVariable(t1, t3)', '    btqnz t3, tagMask, .notCellCase',
  '    cbeq JSCell::m_type[t3], t0, t1',
  '    orq ValueFalse, t1',
  '    storeq t1, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_cell_with_type_length))',
  '.notCellCase:', '    storeq ValueFalse, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_cell_with_type_length))',
  '_llint_op_is_object:',
  '    traceExecution()',
  '    loadisFromInstruction(2, t1)',
  ...
  '    orq ValueFalse, t1', '    storeq t1, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_object_length))',
  '.opIsObjectNotCell:', '    storeq ValueFalse, 0[cfr, t2, 8]',
  '    dispatch(constexpr (op_is_object_length))',
  ...
  '    negi propertyOffsetAsInt', '    sxi2q propertyOffsetAsInt, propertyOffsetAsInt',
  '    jmp .ready',
  '.isInline:',
  '    addp (sizeof JSObject - ((firstOutOfLineOffset - 2) * 8)), objectAndStorage',
  '.ready:', '    loadq ((firstOutOfLineOffset - 2) * 8)[objectAndStorage, propertyOffsetAsInt, 8], value',
  'end',
  ...
  '.isInline:',
  '    addp (sizeof JSObject - ((firstOutOfLineOffset - 2) * 8)), objectAndStorage',
  '.ready:', '    storeq value, ((firstOutOfLineOffset - 2) * 8)[objectAndStorage, propertyOffsetAsInt, 8]',
  'end',
  '_llint_op_get_by_id:',
  '    traceExecution()',
  '    loadisFromInstruction(2, t0)',
  '    loadConstantOrVariableCell(t0, t3, .opGetByIdSlow)', '    loadi JSCell::m_structureID[t3], t1',
  '    loadisFromInstruction(4, t2)',
  '    bineq t2, t1, .opGetByIdSlow',
  '    loadisFromInstruction(5, t1)',
  '    loadisFromInstruction(1, t2)', '    loadPropertyAtVariableOffset(t1, t3, t0)',
  '    storeq t0, 0[cfr, t2, 8]',
  '    valueProfile(t0, 8, t1)',
  '    dispatch(constexpr (op_get_by_id_length))',
  '.opGetByIdSlow:', '    callOpcodeSlowPath(_llint_slow_path_get_by_id)',
  '    dispatch(constexpr (op_get_by_id_length))',
  '_llint_op_get_by_id_proto_load:',
  '    traceExecution()', '    loadisFromInstruction(2, t0)',
  '    loadConstantOrVariableCell(t0, t3, .opGetByIdProtoSlow)',
  '    loadi JSCell::m_structureID[t3], t1',
  '    loadisFromInstruction(4, t2)', '    bineq t2, t1, .opGetByIdProtoSlow',
  '    loadisFromInstruction(5, t1)',
  ...
  '.opGetByIdProtoSlow:', '    callOpcodeSlowPath(_llint_slow_path_get_by_id)',
  '    dispatch(constexpr (op_get_by_id_proto_load_length))',
  ...
  '    loadisFromInstruction(1, t2)', '    storeq ValueUndefined, 0[cfr, t2, 8]',
  '    valueProfile(ValueUndefined, 8, t1)',
  '    dispatch(constexpr (op_get_by_id_unset_length))',
  '.opGetByIdUnsetSlow:', '    callOpcodeSlowPath(_llint_slow_path_get_by_id)',
  '    dispatch(constexpr (op_get_by_id_unset_length))',
  '_llint_op_get_array_length:',
  '    traceExecution()', '    loadisFromInstruction(2, t0)',
  '    loadpFromInstruction(4, t1)',
  '    loadConstantOrVariableCell(t0, t3, .opGetArrayLengthSlow)',
  '    move t3, t2', '    arrayProfile(t2, t1, t0)',
  '    btiz t2, IsArray, .opGetArrayLengthSlow',
  '    btiz t2, IndexingShapeMask, .opGetArrayLengthSlow', '    loadisFromInstruction(1, t1)',
  '    loadCaged(_g_jsValueGigacageBasePtr, JSObject::m_butterfly[t3], t0, t2)',
  '    loadi ((-sizeof IndexingHeader) + IndexingHeader::u.lengths.publicLength)[t0], t0',
  '    bilt t0, 0, .opGetArrayLengthSlow',
  '    orq tagTypeNumber, t0', '    valueProfile(t0, 8, t2)',
  '    storeq t0, 0[cfr, t1, 8]',
  ...
  '    loadisFromInstruction(3, t1)', '    loadConstantOrVariable(t1, t3)',
  ...
  '    bplt t1, PutByIdSecondaryTypeObjectOrOther, \.' +
  ...
  '.opPutByIdTypeCheckOther:', '    andq (~TagBitUndefined), t3',
  '    bqeq t3, ValueNull, .opPutByIdDoneCheckingTypes',
  '    jmp .opPutByIdSlow',
  '.opPutByIdTypeCheckLessThanObjectOrOther:', '    btqnz t3, tagMask, .opPutByIdSlow',
  ...
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckObject:',
  '    bbaeq JSCell::m_type[t3], ObjectType, .opPutByIdDoneCheckingTypes',
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckSymbol:',
  '    bbeq JSCell::m_type[t3], SymbolType, .opPutByIdDoneCheckingTypes',
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckLessThanString:',
  ...
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckNumber:',
  '    btqnz t3, tagTypeNumber, .opPutByIdDoneCheckingTypes',
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckLessThanInt32:',
  '    bpneq t1, PutByIdSecondaryTypeBoolean, .opPutByIdTypeCheckBottomOrOther',
  '    xorq ValueFalse, t3',
  '    btqz t3, (~1), .opPutByIdDoneCheckingTypes', '    jmp .opPutByIdSlow',
  '.opPutByIdTypeCheckBottomOrOther:',
  '    bpeq t1, PutByIdSecondaryTypeOther, .opPutByIdTypeCheckOther',
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckObjectWithStructureOrOther:',
  ...
  '    jmp .opPutByIdSlow', '.opPutByIdTypeCheckObjectWithStructure:',
  '    urshiftp 3, t1',
  '    bineq t1, JSCell::m_structureID[t3], .opPutByIdSlow',
  '.opPutByIdDoneCheckingTypes:', '    loadisFromInstruction(6, t1)',
  '    btiz t1, .opPutByIdNotTransition',
  '    loadpFromInstruction(7, t3)',
  '    btpz t3, .opPutByIdTransitionDirect', '    loadp StructureChain::m_vector[t3], t3',
  '    assert(macro (ok)',
  '    btpnz t3, ok',
  'end)', '    structureIDToStructureWithScratch(t2, t1)',
  '    loadq Structure::m_prototype[t2], t2',
  '    bqeq t2, ValueNull, .opPutByIdTransitionChainDone',
  '.opPutByIdTransitionChainLoop:',
  '    loadp 0[t3], t1', '    loadi JSCell::m_structureID[t2], t2',
  '    bineq t2, (Structure::m_blob + StructureIDBlob::u.fields.structureID)[t1], .opPutByIdSlow',
  '    addp 8, t3', '    loadq Structure::m_prototype[t1], t2',
  '    bqneq t2, ValueNull, .opPutByIdTransitionChainLoop',
  '.opPutByIdTransitionChainDone:',
  '    loadisFromInstruction(6, t1)', '.opPutByIdTransitionDirect:',
  '    storei t1, JSCell::m_structureID[t0]',
  '    writeBarrierOnOperand(1)',
  '    loadisFromInstruction(1, t1)',
  '    loadConstantOrVariable(t1, t0)', '.opPutByIdNotTransition:',
  '    loadisFromInstruction(3, t1)',
  '    loadConstantOrVariable(t1, t2)',
  '    loadisFromInstruction(5, t1)',
  '    storePropertyAtVariableOffset(t1, t0, t2, t3)', '    writeBarrierOnOperands(1, 3)',
  '    dispatch(constexpr (op_put_by_id_length))',
  '.opPutByIdSlow:',
  '    callOpcodeSlowPath(_llint_slow_path_put_by_id)',
  '    dispatch(constexpr (op_put_by_id_length))', 'macro finishGetByVal(result, scratch)',
  ...
  'end', 'macro finishDoubleGetByVal(result, scratch1, scratch2)',
  '    fd2q result, scratch1',
  '    subq tagTypeNumber, scratch1',
  '    finishGetByVal(scratch1, scratch2)', 'end',
  '_llint_op_get_by_val:',
  '    traceExecution()',
  '    loadisFromInstruction(2, t2)',
  '    loadConstantOrVariableCell(t2, t0, .opGetByValSlow)',
  '    loadpFromInstruction(4, t3)', '    move t0, t2',
  '    arrayProfile(t2, t3, t1)',
  '    loadisFromInstruction(3, t3)',
  '    loadConstantOrVariableInt32(t3, t1, .opGetByValSlow)',
  '    sxi2q t1, t1', '    loadCaged(_g_jsValueGigacageBasePtr, JSObject::m_butterfly[t0], t3, t5)',
  '    andi IndexingShapeMask, t2',
  '    bieq t2, Int32Shape, .opGetByValIsContiguous',
  '    bineq t2, ContiguousShape, .opGetByValNotContiguous', '.opGetByValIsContiguous:',
  '    biaeq t1, ((-sizeof IndexingHeader) + IndexingHeader::u.lengths.publicLength)[t3], .opGetByValOutOfBounds',
  '    loadisFromInstruction(1, t0)',
  '    loadq 0[t3, t1, 8], t2',
  '    btqz t2, .opGetByValOutOfBounds', '    jmp .opGetByValDone',
  '.opGetByValNotContiguous:',
  '    bineq t2, DoubleShape, .opGetByValNotDouble',
  '    biaeq t1, ((-sizeof IndexingHeader) + IndexingHeader::u.lengths.publicLength)[t3], .opGetByValOutOfBounds',
  '    loadis 8[PB, PC, 8], t0', '    loadd 0[t3, t1, 8], ft0',
  '    bdnequn ft0, ft0, .opGetByValOutOfBounds',
  '    fd2q ft0, t2',
  '    subq tagTypeNumber, t2', '    jmp .opGetByValDone',
  '.opGetByValNotDouble:',
  ...
  '    loadisFromInstruction(1, t0)', '    loadq ArrayStorage::m_vector[t3, t1, 8], t2',
  '    btqz t2, .opGetByValOutOfBounds',
  '.opGetByValDone:',
  '    storeq t2, 0[cfr, t0, 8]',
  '    valueProfile(t2, 5, t0)',
  '    dispatch(constexpr (op_get_by_val_length))', '.opGetByValOutOfBounds:',
  '    loadpFromInstruction(4, t0)',
  '    storeb 1, ArrayProfile::m_outOfBounds[t0]',
  '    jmp .opGetByValSlow',
  '.opGetByValNotIndexedStorage:', '    loadb JSCell::m_type[t0], t2',
  ...
  '    bia t2, (Uint8ClampedArrayType - FirstArrayType), \.' +
  ...
  '    loadbs 0[t3, t1, 1], t0', '    finishIntGetByVal(t0, t1)',
  '.opGetByValInt16Array:',
  '    loadhs 0[t3, t1, 2], t0',
  '    finishIntGetByVal(t0, t1)', '.opGetByValInt32ArrayOrUint8Array:',
  '    bieq t2, (Int32ArrayType - FirstArrayType), .opGetByValInt32Array',
  '    loadb 0[t3, t1, 1], t0',
  '    finishIntGetByVal(t0, t1)',
  '.opGetByValInt32Array:', '    loadi 0[t3, t1, 4], t0',
  '    finishIntGetByVal(t0, t1)',
  '.opGetByValAboveUint8ClampedArray:',
  ...
  '    writeBarrierOnOperands(1, 3)', 'end)',
  '.opPutByValNotInt32:',
  '    bineq t2, DoubleShape, .opPutByValNotDouble',
  '    contiguousPutByVal(macro (operand, scratch, address)',
  '    loadConstantOrVariable(operand, scratch)',
  '    bqb scratch, tagTypeNumber, .notInt', '    ci2d scratch, ft0',
  '    jmp .ready',
  '.notInt:',
  '    addp tagTypeNumber, scratch',
  '    fq2d scratch, ft0',
  '    bdnequn ft0, ft0, .opPutByValSlow', '.ready:',
  '    stored ft0, address',
  '    writeBarrierOnOperands(1, 3)',
  'end)',
  '.opPutByValNotDouble:', '    bineq t2, ContiguousShape, .opPutByValNotContiguous',
  '    contiguousPutByVal(macro (operand, scratch, address)',
  '    loadConstantOrVariable(operand, scratch)',
  '    storep scratch, address',
  '    writeBarrierOnOperands(1, 3)',
  'end)', '.opPutByValNotContiguous:',
  '    bineq t2, ArrayStorageShape, .opPutByValSlow',
  '    biaeq t3, ((-sizeof IndexingHeader) + IndexingHeader::u.lengths.vectorLength)[t0], .opPutByValOutOfBounds',
  '    btqz ArrayStorage::m_vector[t0, t3, 8], .opPutByValArrayStorageEmpty',
  '.opPutByValArrayStorageStoreResult:',
  '    loadisFromInstruction(3, t2)', '    loadConstantOrVariable(t2, t1)',
  '    storeq t1, ArrayStorage::m_vector[t0, t3, 8]',
  '    writeBarrierOnOperands(1, 3)',
  '    dispatch(5)',
  '.opPutByValArrayStorageEmpty:', '    loadpFromInstruction(4, t1)',
  '    storeb 1, ArrayProfile::m_mayStoreToHole[t1]',
  '    addi 1, ArrayStorage::m_numValuesInVector[t0]',
  '    bib t3, ((-sizeof IndexingHeader) + IndexingHeader::u.lengths.publicLength)[t0], \.' +
    'opPutByValArrayStorageStoreResult',
  '    addi 1, t3, t1',
  '    storei t1, ((-sizeof IndexingHeader) + IndexingHeader::u.lengths.publicLength)[t0]',
  '    jmp .opPutByValArrayStorageStoreResult',
  '.opPutByValOutOfBounds:', '    loadpFromInstruction(4, t0)',
  '    storeb 1, ArrayProfile::m_outOfBounds[t0]',
  '.opPutByValSlow:',
  '    callOpcodeSlowPath(slowPath)',
  '    dispatch(5)', 'end',
  ...
  '_llint_op_jmp:', '    traceExecution()',
  '    dispatchIntIndirect(1)',
  'macro jumpTrueOrFalse(conditionOp, slow)',
  '    loadisFromInstruction(1, t1)',
  '    loadConstantOrVariable(t1, t0)',
  '    xorq ValueFalse, t0', '    btqnz t0, (-1), .slow',
  '    conditionOp(t0, .target)',
  '    dispatch(3)',
  '.target:', '    dispatchIntIndirect(2)',
  '.slow:',
  ...
  '    loadp CodeBlock[cfr], t0', '    loadp CodeBlock::m_globalObject[t0], t0',
  '    bpeq Structure::m_globalObject[structure], t0, target',
  '.notMasqueradesAsUndefined:',
  'end, macro (value, target)', '    bqeq value, ValueNull, target',
  'end)', '_llint_op_jneq_null:',
  '    traceExecution()',
  '    equalNull(macro (structure, value, target)',
  ...
  '    bqneq value, ValueNull, target', 'end)',
  '_llint_op_jneq_ptr:',
  '    traceExecution()',
  '    loadisFromInstruction(1, t0)',
  '    loadisFromInstruction(2, t1)',
  ...
  '    dispatch(5)',
  '.opJneqPtrTarget:', '    storei 1, 32[PB, PC, 8]',
  '    dispatchIntIndirect(3)',
  'macro compare(integerCompare, doubleCompare, slowPath)',
  '    loadisFromInstruction(1, t2)',
  '    loadisFromInstruction(2, t3)', '    loadConstantOrVariable(t2, t0)',
  '    loadConstantOrVariable(t3, t1)',
  '    bqb t0, tagTypeNumber, .op1NotInt',
  '    bqb t1, tagTypeNumber, .op2NotInt',
  '    integerCompare(t0, t1, .jumpTarget)',
  '    dispatch(4)', '.op1NotInt:',
  '    btqz t0, tagTypeNumber, .slow',
  '    bqb t1, tagTypeNumber, .op1NotIntOp2NotInt',
  '    ci2d t1, ft1',
  '    jmp .op1NotIntReady', '.op1NotIntOp2NotInt:',
  '    btqz t1, tagTypeNumber, .slow',
  '    addq tagTypeNumber, t1',
  '    fq2d t1, ft1', '.op1NotIntReady:',
  '    addq tagTypeNumber, t0',
  '    fq2d t0, ft0',
  '    doubleCompare(ft0, ft1, .jumpTarget)', '    dispatch(4)',
  '.op2NotInt:',
  '    ci2d t0, ft0',
  '    btqz t1, tagTypeNumber, .slow',
  '    addq tagTypeNumber, t1',
  '    fq2d t1, ft1', '    doubleCompare(ft0, ft1, .jumpTarget)',
  '    dispatch(4)',
  '.jumpTarget:',
  '    dispatchIntIndirect(3)',
  '.slow:',
  '    callOpcodeSlowPath(slowPath)', '    dispatch(0)',
  'end',
  '_llint_op_switch_imm:',
  '    traceExecution()',
  '    loadisFromInstruction(3, t2)',
  '    loadisFromInstruction(1, t3)', '    loadConstantOrVariable(t2, t1)',
  '    loadp CodeBlock[cfr], t2',
  '    loadp CodeBlock::m_rareData[t2], t2',
  '    muli sizeof SimpleJumpTable, t3',
  '    loadp (CodeBlock::RareData::m_switchJumpTables + VectorBufferOffset)[t2], t2',
  '    addp t3, t2', '    bqb t1, tagTypeNumber, .opSwitchImmNotInt',
  ...
  '    loadis 0[t3, t1, 4], t1', '    btiz t1, .opSwitchImmFallThrough',
  '    dispatch(t1)',
  '.opSwitchImmNotInt:',
  '    btqnz t1, tagTypeNumber, .opSwitchImmSlow',
  '.opSwitchImmFallThrough:', '    dispatchIntIndirect(2)',
  '.opSwitchImmSlow:',
  '    callOpcodeSlowPath(_llint_slow_path_switch_imm)',
  '    dispatch(0)',
  '_llint_op_switch_char:', '    traceExecution()',
  '    loadisFromInstruction(3, t2)',
  '    loadisFromInstruction(1, t3)',
  '    loadConstantOrVariable(t2, t1)',
  '    loadp CodeBlock[cfr], t2', '    loadp CodeBlock::m_rareData[t2], t2',
  '    muli sizeof SimpleJumpTable, t3',
  '    loadp (CodeBlock::RareData::m_switchJumpTables + VectorBufferOffset)[t2], t2',
  '    addp t3, t2', '    btqnz t1, tagMask, .opSwitchCharFallThrough',
  ...
  '    btpz t0, .opSwitchOnRope', '    loadp StringImpl::m_data8[t0], t1',
  '    btinz StringImpl::m_hashAndFlags[t0], HashFlags8BitBuffer, .opSwitchChar8Bit',
  '    loadh 0[t1], t0',
  '    jmp .opSwitchCharReady',
  '.opSwitchChar8Bit:',
  '    loadb 0[t1], t0', '.opSwitchCharReady:',
  ...
  '    loadis 0[t2, t0, 4], t1', '    btiz t1, .opSwitchCharFallThrough',
  '    dispatch(t1)',
  '.opSwitchCharFallThrough:',
  '    dispatchIntIndirect(2)',
  '.opSwitchOnRope:', '    callOpcodeSlowPath(_llint_slow_path_switch_char)',
  '    dispatch(0)',
  'macro arrayProfileForCall()',
  '    loadisFromInstruction(4, t3)',
  '    negp t3', '    loadq ThisArgumentOffset[cfr, t3, 8], t0',
  ...
  '    loadConstantOrVariable(t0, t3)', '    bqneq t3, t2, .opCallSlow',
  '    loadisFromInstruction(4, t3)',
  '    lshifti 3, t3',
  '    negp t3',
  '    addp cfr, t3', '    storeq t2, Callee[t3]',
  '    loadisFromInstruction(3, t2)',
  '    storei PC, (ArgumentCount + TagOffset)[cfr]',
  '    storei t2, (ArgumentCount + PayloadOffset)[t3]',
  '    move t3, sp', '    prepareCall(LLIntCallLinkInfo::machineCodeTarget[t1], t2, t3, t4)',
  '    callTargetFunction(LLIntCallLinkInfo::machineCodeTarget[t1])',
  '.opCallSlow:',
  '    slowPathForCall(slowPath, prepareCall)',
  'end',
  '_llint_op_ret:', '    traceExecution()',
  '    checkSwitchToJITForEpilogue()',
  '    loadisFromInstruction(1, t2)',
  '    loadConstantOrVariable(t2, r0)',
  '    doReturn()',
  '_llint_op_to_primitive:',
  '    traceExecution()', '    loadisFromInstruction(2, t2)',
  '    loadisFromInstruction(1, t3)',
  '    loadConstantOrVariable(t2, t0)',
  '    btqnz t0, tagMask, .opToPrimitiveIsImm',
  '    bbaeq JSCell::m_type[t0], ObjectType, .opToPrimitiveSlowCase',
  '.opToPrimitiveIsImm:', '    storeq t0, 0[cfr, t3, 8]',
  '    dispatch(constexpr (op_to_primitive_length))',
  '.opToPrimitiveSlowCase:',
  '    callOpcodeSlowPath(_slow_path_to_primitive)',
  '    dispatch(constexpr (op_to_primitive_length))',
  '_llint_op_catch:', '    loadp Callee[cfr], t3',
  '    andp MarkedBlockMask, t3',
  '    loadp MarkedBlock::m_vm[t3], t3',
  '    restoreCalleeSavesFromVMEntryFrameCalleeSavesBuffer(t3, t0)',
  '    loadp VM::callFrameForCatch[t3], cfr',
  '    storep 0, VM::callFrameForCatch[t3]', '    restoreStackPointerAfterCall()',
  '    loadp CodeBlock[cfr], PB',
  '    loadp CodeBlock::m_instructions[PB], PB',
  '    loadp VM::targetInterpreterPCForThrow[t3], PC',
  '    subp PB, PC', '    rshiftp 3, PC',
  ...
  '    loadisFromInstruction(1, t2)', '    storeq t0, 0[cfr, t2, 8]',
  '    loadq Exception::m_value[t0], t3',
  '    loadisFromInstruction(2, t2)',
  '    storeq t3, 0[cfr, t2, 8]',
  '    traceExecution()', '    dispatch(constexpr (op_catch_length))',
  '_llint_op_end:',
  '    traceExecution()',
  '    checkSwitchToJITForEpilogue()',
  '    loadisFromInstruction(1, t0)',
  '    assertNotConstant(t0)', '    loadq 0[cfr, t0, 8], r0',
  '    doReturn()',
  '_llint_throw_from_slow_path_trampoline:',
  '    loadp Callee[cfr], t1',
  '    andp MarkedBlockMask, t1', '    loadp MarkedBlock::m_vm[t1], t1',
  '    copyCalleeSavesToVMEntryFrameCalleeSavesBuffer(t1, t2)',
  '    callSlowPath(_llint_slow_path_handle_exception)',
  '    loadp Callee[cfr], t1', '    andp MarkedBlockMask, t1',
  '    loadp MarkedBlock::m_vm[t1], t1',
  '    jmp VM::targetMachinePCForThrow[t1]',
  '_llint_throw_during_call_trampoline:',
  '    preserveReturnAddressAfterCall(t2)', '    jmp _llint_throw_from_slow_path_trampoline',
  'macro nativeCallTrampoline(executableOffsetToFunction)',
  '    functionPrologue()',
  '    storep 0, CodeBlock[cfr]',
  '    loadp Callee[cfr], t0', '    andp MarkedBlockMask, t0, t1',
  '    loadp MarkedBlock::m_vm[t1], t1',
  '    storep cfr, VM::topCallFrame[t1]',
  'if (ARM64 or C_LOOP)', '    storep lr, ReturnPC[cfr]',
  'else',
  '    skip',
  'end',
  '    move cfr, a0', '    loadp Callee[cfr], t1',
  '    loadp JSFunction::m_executable[t1], t1',
  '    checkStackPointerAlignment(t3, 3735879681)',
  'if C_LOOP', '    cloopCallNative executableOffsetToFunction[t1]',
  'else',
  'if X86_64_WIN',
  '    subp 32, sp',
  'else', '    skip',
  ...
  '.rGlobalLexicalVar:', '    bineq t0, GlobalLexicalVar, .rClosureVar',
  '    getConstantScope(1)',
  '    dispatch(constexpr (op_resolve_scope_length))',
  '.rClosureVar:',
  '    bineq t0, ClosureVar, .rModuleVar',
  '    resolveScope()', '    dispatch(constexpr (op_resolve_scope_length))',
  '.rModuleVar:',
  ...
  '    loadisFromInstruction(operand, t0)', '    loadq 0[cfr, t0, 8], t0',
  '    loadStructureWithScratch(t0, t2, t1)',
  '    loadpFromInstruction(5, t1)',
  '    bpneq t2, t1, slowPath', 'end',
  'macro getProperty()',
  '    loadisFromInstruction(6, t1)',
  '    loadPropertyAtVariableOffset(t1, t0, t2)',
  '    valueProfile(t2, 7, t0)', '    loadisFromInstruction(1, t0)',
  '    storeq t2, 0[cfr, t0, 8]',
  'end',
  'macro getGlobalVar(tdzCheckIfNecessary)',
  '    loadpFromInstruction(6, t0)',
  '    loadq 0[t0], t0', '    tdzCheckIfNecessary(t0)',
  '    valueProfile(t0, 7, t1)',
  '    loadisFromInstruction(1, t1)',
  '    storeq t0, 0[cfr, t1, 8]',
  'end', 'macro getClosureVar()',
  '    loadisFromInstruction(6, t1)',
  ...
  '    traceExecution()',
  '    loadisFromInstruction(4, t0)',
  '    andi ResolveTypeMask, t0', '    bineq t0, GlobalProperty, .gGlobalVar',
  '    loadWithStructureCheck(2, .gDynamic)',
  '    getProperty()',
  '    dispatch(constexpr (op_get_from_scope_length))',
  '.gGlobalVar:', '    bineq t0, GlobalVar, .gGlobalLexicalVar',
  '    getGlobalVar(macro (v)',
  '',
  'end)', '    dispatch(constexpr (op_get_from_scope_length))',
  '.gGlobalLexicalVar:',
  ...
  '    varInjectionCheck(.gDynamic)',
  '    getGlobalVar(macro (value)', '    bqeq value, ValueEmpty, .gDynamic',
  'end)',
  '    dispatch(constexpr (op_get_from_scope_length))',
  '.gClosureVarWithVarInjectionChecks:',
  '    bineq t0, ClosureVarWithVarInjectionChecks, .gDynamic',
  '    varInjectionCheck(.gDynamic)', '    loadVariable(2, t0)',
  '    getClosureVar()',
  '    dispatch(constexpr (op_get_from_scope_length))',
  '.gDynamic:', '    callOpcodeSlowPath(_llint_slow_path_get_from_scope)',
  '    dispatch(constexpr (op_get_from_scope_length))',
  'macro putProperty()', '    loadisFromInstruction(3, t1)',
  '    loadConstantOrVariable(t1, t2)',
  '    loadisFromInstruction(6, t1)',
  '    storePropertyAtVariableOffset(t1, t0, t2, t3)',
  'end', 'macro putGlobalVariable()',
  '    loadisFromInstruction(3, t0)',
  '    loadConstantOrVariable(t0, t1)',
  '    loadpFromInstruction(5, t2)',
  '    loadpFromInstruction(6, t0)',
  '    notifyWrite(t2, .pDynamic)', '    storeq t1, 0[t0]',
  'end', 'macro putClosureVar()',
  '    loadisFromInstruction(3, t1)',
  '    loadConstantOrVariable(t1, t2)',
  '    loadisFromInstruction(6, t1)',
  '    storeq t2, JSEnvironmentRecord_variables[t0, t1, 8]',
  'end', 'macro putLocalClosureVar()',
  '    loadisFromInstruction(3, t1)',
  '    loadConstantOrVariable(t1, t2)',
  '    loadpFromInstruction(5, t3)',
  '    btpz t3, .noVariableWatchpointSet', '    notifyWrite(t3, .pDynamic)',
  '.noVariableWatchpointSet:',
  '    loadisFromInstruction(6, t1)',
  '    storeq t2, JSEnvironmentRecord_variables[t0, t1, 8]',
  'end', 'macro checkTDZInGlobalPutToScopeIfNecessary()',
  '    loadisFromInstruction(4, t0)',
  '    andi InitializationModeMask, t0',
  '    rshifti InitializationModeShift, t0',
  '    bineq t0, NotInitialization, .noNeedForTDZCheck',
  '    loadpFromInstruction(6, t0)', '    loadq 0[t0], t0',
  '    bqeq t0, ValueEmpty, .pDynamic',
  '.noNeedForTDZCheck:',
  'end', '_llint_op_put_to_scope:',
  '    traceExecution()',
  '    loadisFromInstruction(4, t0)',
  '    andi ResolveTypeMask, t0',
  '    bineq t0, LocalClosureVar, .pGlobalProperty',
  '    loadVariable(1, t0)', '    putLocalClosureVar()',
  '    writeBarrierOnOperands(1, 3)',
  '    dispatch(constexpr (op_put_to_scope_length))',
  '.pGlobalProperty:', '    bineq t0, GlobalProperty, .pGlobalVar',
  '    loadWithStructureCheck(1, .pDynamic)',
  '    putProperty()', '    writeBarrierOnOperands(1, 3)',
  '    dispatch(constexpr (op_put_to_scope_length))',
  '.pGlobalVar:', '    bineq t0, GlobalVar, .pGlobalLexicalVar',
  '    writeBarrierOnGlobalObject(3)',
  '    putGlobalVariable()',
  '    dispatch(constexpr (op_put_to_scope_length))',
  '.pGlobalLexicalVar:', '    bineq t0, GlobalLexicalVar, .pClosureVar',
  '    writeBarrierOnGlobalLexicalEnvironment(3)',
  '    checkTDZInGlobalPutToScopeIfNecessary()',
  '    putGlobalVariable()', '    dispatch(constexpr (op_put_to_scope_length))',
  '.pClosureVar:',
  '    bineq t0, ClosureVar, .pGlobalPropertyWithVarInjectionChecks',
  '    loadVariable(1, t0)',
  '    putClosureVar()', '    writeBarrierOnOperands(1, 3)',
  '    dispatch(constexpr (op_put_to_scope_length))',
  ...
  '.opProfileTypeDone:', '    dispatch(constexpr (op_profile_type_length))',
  '_llint_op_profile_control_flow:',
  '    traceExecution()', '    loadpFromInstruction(1, t0)',
  '    addq 1, BasicBlockLocation::m_executionCount[t0]',
  '    dispatch(constexpr (op_profile_control_flow_length))',
  '_llint_op_get_rest_length:',
  '    traceExecution()', '    loadi (PayloadOffset + ArgumentCount)[cfr], t0',
  '    subi 1, t0',
  '    loadisFromInstruction(2, t1)',
  '    bilteq t0, t1, .storeZero',
  '    subi t1, t0', '    jmp .boxUp',
  '.storeZero:',
  '    move 0, t0',
  '.boxUp:',
  '    orq tagTypeNumber, t0', '    loadisFromInstruction(1, t1)',
  '    storeq t0, 0[cfr, t1, 8]',
  '    dispatch(constexpr (op_get_rest_length_length))',
  '_llint_op_log_shadow_chicken_prologue:',
  '    traceExecution()', '    acquireShadowChickenPacket(.opLogShadowChickenPrologueSlow)',
  '    storep cfr, ShadowChicken::Packet::frame[t0]',
  '    loadp CallerFrame[cfr], t1',
  '    storep t1, ShadowChicken::Packet::callerFrame[t0]',
  '    loadp Callee[cfr], t1', '    storep t1, ShadowChicken::Packet::callee[t0]',
  '    loadVariable(1, t1)',
  '    storep t1, ShadowChicken::Packet::scope[t0]',
  '    dispatch(constexpr (op_log_shadow_chicken_prologue_length))',
  '.opLogShadowChickenPrologueSlow:', '    callOpcodeSlowPath(_llint_slow_path_log_shadow_chicken_prologue)',
  '    dispatch(constexpr (op_log_shadow_chicken_prologue_length))',
  '_llint_op_log_shadow_chicken_tail:',
  '    traceExecution()', '    acquireShadowChickenPacket(.opLogShadowChickenTailSlow)',
  '    storep cfr, ShadowChicken::Packet::frame[t0]',
  '    storep ShadowChickenTailMarker, ShadowChicken::Packet::callee[t0]',
  '    loadVariable(1, t1)', '    storep t1, ShadowChicken::Packet::thisValue[t0]',
  '    loadVariable(2, t1)',
  '    storep t1, ShadowChicken::Packet::scope[t0]',
  '    loadp CodeBlock[cfr], t1', '    storep t1, ShadowChicken::Packet::codeBlock[t0]',
