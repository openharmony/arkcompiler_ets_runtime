...
ArkTools.arkSteedCompileSync(makeFloat);
ArkTools.arkSteedCompileSync(startFunction);
ArkTools.arkSteedCompileSync(endFunction);
ArkTools.arkSteedCompileSync(makeTestCase);
