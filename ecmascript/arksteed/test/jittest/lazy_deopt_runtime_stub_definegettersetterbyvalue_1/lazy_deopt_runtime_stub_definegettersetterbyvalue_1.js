...
function Operation()
{
    ...
    // The computed class accessor below generates definegettersetterbyvalue in this function.
    // triggerKey.toString()/valueOf() drives the lazy-deopt trigger in the same accessor-definition sequence.
    class Holder {
        get [triggerKey]() {
            return 7;
        }
...
runCase("lazy_deopt_runtime_stub_definegettersetterbyvalue_1");
