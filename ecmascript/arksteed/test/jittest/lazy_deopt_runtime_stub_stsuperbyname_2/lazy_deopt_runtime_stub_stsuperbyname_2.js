...
function Operation()
{
    ...
    let result = "unset";
    try {
        // The following expression triggers super property store invokes the BaseForSuper setter.
        // That runtime-stub bytecode site is where the compiled run triggers lazy-deopt.
        result = "ok:" + (superReceiver.stByName(12));
    } catch (e) {
        result = "caught:" + e;
    }
    let after = obj.x;
...
runCase("lazy_deopt_runtime_stub_stsuperbyname_2");
