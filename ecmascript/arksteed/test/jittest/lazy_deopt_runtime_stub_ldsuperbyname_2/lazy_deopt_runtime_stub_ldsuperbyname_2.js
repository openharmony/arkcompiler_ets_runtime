...
function Operation()
{
    ...
    let result = "unset";
    try {
        // The following expression triggers super property load invokes the BaseForSuper getter.
        // That runtime-stub bytecode site is where the compiled run triggers lazy-deopt.
        result = "ok:" + (superReceiver.ldByName());
    } catch (e) {
        result = "caught:" + e;
    }
    let after = obj.x;
...
runCase("lazy_deopt_runtime_stub_ldsuperbyname_2");
