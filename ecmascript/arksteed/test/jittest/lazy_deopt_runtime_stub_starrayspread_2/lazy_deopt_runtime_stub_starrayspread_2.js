...
function Operation()
{
    ...
    let result = "unset";
    try {
        // The following expression triggers array spread stores values read from the iterable/proxy source.
        // That runtime-stub bytecode site is where the compiled run triggers lazy-deopt.
        result = "ok:" + (([1, ...sourceObject]).length);
    } catch (e) {
        result = "caught:" + e;
    }
    let after = obj.x;
...
runCase("lazy_deopt_runtime_stub_starrayspread_2");
