...
ArkTools.arkSteedCompileAsync(Test1);
...
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test4);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test5);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test6);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test7);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test8);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test9);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
ArkTools.arkSteedCompileAsync(Test10);
print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
...

{
    ...
    ArkTools.arkSteedCompileAsync(Test11);
    print((() => { let time = Date.now(); for (let cur = Date.now(); cur - time < 1000; cur = Date.now()) {}; return true; })());
    Test11(b);
    Test11(a);
    Test11(s);
