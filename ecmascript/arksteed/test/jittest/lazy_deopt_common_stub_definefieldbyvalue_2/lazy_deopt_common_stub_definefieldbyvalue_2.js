...
function Operation()
{
    ...
    let result = "unset";
    try {
        // The following property-key conversion runs user code through keyLike.toString()/valueOf().
...
runCase("lazy_deopt_common_stub_definefieldbyvalue_2");
