...
class SubjectCtor extends BaseCtor {
    constructor(value) {
        ...
        // SUPERCALLTHISRANGE is the selected runtime-stub bytecode; BaseCtor mutates
        // the dependency while this constructor is still live.
        super(value);
        let after = obj.x;
...
runCase("lazy_deopt_runtime_stub_supercallthisrange_1");
