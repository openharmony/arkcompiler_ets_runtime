...
// A keeps several live locals across A -> B -> C -> D -> E -> F.
// F invalidates A's dependency; A must resume with correct locals after lazy-deopt.
...
function A(o, seed, shouldChange) {
    let before = o.x;
