...
// JIT compile
ArkTools.arkSteedCompileSync(optionalChainBasic);
ArkTools.arkSteedCompileSync(optionalChainNull);
ArkTools.arkSteedCompileSync(optionalChainMethod);
ArkTools.arkSteedCompileSync(optionalChainArray);
ArkTools.arkSteedCompileSync(optionalChainAssign);
ArkTools.arkSteedCompileSync(nullishBasic);
ArkTools.arkSteedCompileSync(nullishWithOptional);
ArkTools.arkSteedCompileSync(nullishAssignment);
ArkTools.arkSteedCompileSync(nullishVsOr);
ArkTools.arkSteedCompileSync(templateBasic);
ArkTools.arkSteedCompileSync(templateMultiLine);
ArkTools.arkSteedCompileSync(templateExpression);
ArkTools.arkSteedCompileSync(templateNested);
ArkTools.arkSteedCompileSync(templateTagged);
ArkTools.arkSteedCompileSync(templateWithCall);
ArkTools.arkSteedCompileSync(computedBasic);
ArkTools.arkSteedCompileSync(computedExpression);
ArkTools.arkSteedCompileSync(computedMethods);
ArkTools.arkSteedCompileSync(computedSymbol);
ArkTools.arkSteedCompileSync(symbolCreation);
ArkTools.arkSteedCompileSync(symbolProperty);
ArkTools.arkSteedCompileSync(symbolWellKnown);
ArkTools.arkSteedCompileSync(symbolIterator);
ArkTools.arkSteedCompileSync(symbolDescription);
ArkTools.arkSteedCompileSync(logicalAndAssign);
ArkTools.arkSteedCompileSync(logicalOrAssign);
ArkTools.arkSteedCompileSync(combinedPatterns);

print("compile optionalChainBasic: " + true);
print("compile optionalChainNull: " + true);
print("compile optionalChainMethod: " + true);
print("compile optionalChainArray: " + true);
print("compile optionalChainAssign: " + true);
print("compile nullishBasic: " + true);
print("compile nullishWithOptional: " + true);
print("compile nullishAssignment: " + true);
print("compile nullishVsOr: " + true);
print("compile templateBasic: " + true);
print("compile templateMultiLine: " + true);
print("compile templateExpression: " + true);
print("compile templateNested: " + true);
print("compile templateTagged: " + true);
print("compile templateWithCall: " + true);
print("compile computedBasic: " + true);
print("compile computedExpression: " + true);
print("compile computedMethods: " + true);
print("compile computedSymbol: " + true);
print("compile symbolCreation: " + true);
print("compile symbolProperty: " + true);
print("compile symbolWellKnown: " + true);
print("compile symbolIterator: " + true);
print("compile symbolDescription: " + true);
print("compile logicalAndAssign: " + true);
print("compile logicalOrAssign: " + true);
print("compile combinedPatterns: " + true);
