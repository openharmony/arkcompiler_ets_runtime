...
print("Before 1st call: isCompiled:", ArkTools.arkSteedIsCompiled(Test2));
Test2(c, false);
print("After 1st call: isCompiled:", ArkTools.arkSteedIsCompiled(Test2));
print("----------------");
...
print("Before 2nd call: isCompiled:", ArkTools.arkSteedIsCompiled(Test2));
Test2(c, true);
print("After 2nd call: isCompiled:", ArkTools.arkSteedIsCompiled(Test2));
print("----------------");
