...
function Operation()
{
    ...
    const target = { namedMethod() { return 38; } };
    ...
    proxyObject.namedMethod = target.namedMethod;
    let result = proxyObject.namedMethod();
    let after = obj.x;
    let tail = 0;
    for (let i = 0; i < 3; i++) {
        tail += after + i;
...
runCase("lazy_deopt_common_stub_stownbynamewithnameset_1");
