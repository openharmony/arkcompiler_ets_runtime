...
function Operation()
{
    ...
    try {
        ...
        for (let key in enumObject) {
            // GETNEXTPROPNAME advances the for-in iterator inside a cold-catch try block.
            // This runtime-stub bytecode is the potential lazy-deopt site for this case.
            result += key;
            if (index === 0) {
...
runCase("lazy_deopt_runtime_stub_getnextpropname_2");
