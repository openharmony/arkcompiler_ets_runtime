...
let lazyCommonStubGlobalValue = 50;
Object.defineProperty(globalThis, "lazyCommonStubGlobal", {
    configurable: true,
    get() {
        invalidateDependency();
        invalidateAndThrow();
        return lazyCommonStubGlobalValue;
    },
    set(value) {
        invalidateDependency();
        invalidateAndThrow();
        lazyCommonStubGlobalValue = value;
    }
});
function Operation()
{
    ...
    let result = "unset";
    try {
        // The following global access invokes the accessor on globalThis.
        // That common-stub bytecode site is where the compiled run triggers lazy-deopt.
        lazyCommonStubGlobal = 43;
        result = "ok:" + lazyCommonStubGlobal;
    } catch (e) {
        result = "caught:" + e;
    }
    let after = obj.x;
...
runCase("lazy_deopt_common_stub_trystglobalbyname_2");
