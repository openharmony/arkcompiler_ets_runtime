...
function Operation()
{
    ...
    let result = "unset";
    try {
        // The following object literal emits SETOBJECTWITHPROTO for the __proto__ property.
        // The second run throws after the bytecode for E coverage; the third run invalidates
        // the dependency after the bytecode for D coverage.
        let created = { __proto__: prototypeObject, value: 8 };
...
runCase("lazy_deopt_runtime_stub_setobjectwithproto_2");
