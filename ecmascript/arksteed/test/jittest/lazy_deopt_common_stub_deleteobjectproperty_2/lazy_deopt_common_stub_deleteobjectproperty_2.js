...
function Operation()
{
    ...
    try {
        proxyStorage.k = 10;
        // The following keyed Proxy operation converts keyLike and then enters a Proxy trap.
        // That common-stub bytecode site is where the compiled run triggers lazy-deopt.
        result = "ok:" + (delete proxyObject[keyLike]);
    } catch (e) {
        result = "caught:" + e;
    }
    let after = obj.x;
...
runCase("lazy_deopt_common_stub_deleteobjectproperty_2");
