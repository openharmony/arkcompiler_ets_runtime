...
class SubjectCtor extends BaseCtor {
    constructor(values) {
        ...
        // SUPERCALLSPREAD is the selected runtime-stub bytecode; BaseCtor mutates
        // the dependency after spread arguments are prepared.
        super(...values);
        let after = obj.x;
...
runCase("lazy_deopt_runtime_stub_supercallspread_1");
