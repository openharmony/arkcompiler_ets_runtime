...
function Operation()
{
    ...
    try {
        ...
        // triggerKey.toString()/valueOf() can independently throw or invalidate the prototype dependency there.
        class Holder {
            [triggerKey] = 7;
        }
        result = "ok:" + ((new Holder()).k);
    } catch (e) {
        result = "caught:" + e;
    }
    let after = obj.x;
...
runCase("lazy_deopt_runtime_stub_topropertykey_2");
