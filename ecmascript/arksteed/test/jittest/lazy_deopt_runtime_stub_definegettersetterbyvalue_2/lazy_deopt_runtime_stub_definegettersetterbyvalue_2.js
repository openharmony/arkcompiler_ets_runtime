...
function Operation()
{
    ...
    try {
        ...
        // triggerKey.toString()/valueOf() can independently throw or invalidate during the accessor-definition sequence.
        class Holder {
            get [triggerKey]() {
                return 7;
            }
...
runCase("lazy_deopt_runtime_stub_definegettersetterbyvalue_2");
