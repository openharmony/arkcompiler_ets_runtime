...
ArkTools.arkSteedCompileSync(Test1);
print(true);
ArkTools.arkSteedCompileSync(Test2);
print(true);
ArkTools.arkSteedCompileSync(Test3);
print(true);
ArkTools.arkSteedCompileSync(Test4);
print(true);
ArkTools.arkSteedCompileSync(Test5);
print(true);
ArkTools.arkSteedCompileSync(Test6);
print(true);
ArkTools.arkSteedCompileSync(Test7);
print(true);
ArkTools.arkSteedCompileSync(Test8);
print(true);
ArkTools.arkSteedCompileSync(Test9);
print(true);
ArkTools.arkSteedCompileSync(Test10);
print(true);
