...
{
    EcmaStringTable *table = thread->GetCurrentEcmaContext()->GetEcmaStringTable();
...
{
    EXPECT_TRUE(thread->GetCurrentEcmaContext()->GetEcmaStringTable()->CheckStringTableValidity());
}
}  // namespace panda::test
