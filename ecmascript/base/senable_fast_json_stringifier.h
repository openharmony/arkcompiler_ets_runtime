...
#ifndef ECMASCRIPT_BASE_SENDABLE_FAST_JSON_STRINGIFY_H
#define ECMASCRIPT_BASE_SENDABLE_FAST_JSON_STRINGIFY_H
...
class SendableFastJsonStringifier {
public:
    ...
    SendableFastJsonStringifier() = default;

    explicit SendableFastJsonStringifier(JSThread *thread) : thread_(thread) {}

    ~SendableFastJsonStringifier() = default;
    NO_COPY_SEMANTIC(SendableFastJsonStringifier);
    NO_MOVE_SEMANTIC(SendableFastJsonStringifier);
...
#endif  // ECMASCRIPT_BASE_SENDABLE_FAST_JSON_STRINGIFY_H
