...
#define DEF_MESSAGE_ID(name) Message_##name,
        ASM_INTERPRETER_BC_STUB_LIST(DEF_MESSAGE_ID, DEF_MESSAGE_ID)
...
#define DEF_MESSAGE_ID_DYN(name, ...) DEF_MESSAGE_ID(name)
        ...
        ASM_INTERPRETER_BC_JIT_PROFILER_STUB_LIST(DEF_MESSAGE_ID_DYN)
    #endif
#undef DEF_MESSAGE_ID_DYN
#endif
#define DEF_STW_COPY_MESSAGE_ID(name) Message_##name##StwCopy,
        ASM_INTERPRETER_BC_STW_COPY_STUB_LIST(DEF_STW_COPY_MESSAGE_ID)
        COMMON_STUB_LIST(DEF_MESSAGE_ID)
        COMMON_STW_COPY_STUB_LIST(DEF_STW_COPY_MESSAGE_ID)
...
#define DEF_BUILTINS_STW_COPY_STUB_MESSAGE_ID(name, type, ...) Message_##type##name##StwCopy,
        BUILTINS_STW_COPY_STUB_LIST(DEF_STW_COPY_MESSAGE_ID, DEF_BUILTINS_STW_COPY_STUB_MESSAGE_ID, \
            DEF_STW_COPY_MESSAGE_ID)
#undef DEF_BUILTINS_STW_COPY_STUB_MESSAGE_ID
#undef DEF_STW_COPY_MESSAGE_ID
        BASELINE_STUB_ID_LIST(DEF_MESSAGE_ID)
...
#undef DEF_MESSAGE_ID
        ...
        BUILTINS_STUB_START = Message_StringCharAt,
        BUILTINS_STUB_LAST = Message_ArrayConstructor,
    };

    static void CheckStubNameInfo();
