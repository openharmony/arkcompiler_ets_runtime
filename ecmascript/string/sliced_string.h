...
#ifndef ECMASCRIPT_STRING_SLICED_STRING_H
...
public:
    STRING_CAST_CHECK(SlicedString, IsSlicedString);
    ...
    static SlicedString *Create(Allocator &&allocator, WriteBarrier &&writeBarrier,
...
#endif  // ECMASCRIPT_STRING_SLICED_STRING_H
