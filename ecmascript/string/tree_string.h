...
#ifndef ECMASCRIPT_STRING_TREE_STRING_H
#define ECMASCRIPT_STRING_TREE_STRING_H
...
public:
    STRING_CAST_CHECK(TreeString, IsTreeString);
    ...
    template <typename Allocator, typename WriteBarrier,
              panda::objects_traits::enable_if_is_allocate<Allocator, BaseObject *> = 0,
              common::objects_traits::enable_if_is_write_barrier<WriteBarrier> = 0>
    static TreeString *Create(Allocator &&allocator, WriteBarrier &&writeBarrier,
...
#endif  // ECMASCRIPT_STRING_TREE_STRING_H
