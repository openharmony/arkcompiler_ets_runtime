...
static_assert(static_cast<uint8_t>(JSType::LINE_STRING) == static_cast<uint8_t>(ObjectType::LINE_STRING) &&
    "line string type should be same with common type");
static_assert(static_cast<uint8_t>(JSType::SLICED_STRING) == static_cast<uint8_t>(ObjectType::SLICED_STRING) &&
    "sliced string type should be same with common type");
static_assert(static_cast<uint8_t>(JSType::TREE_STRING) == static_cast<uint8_t>(ObjectType::TREE_STRING) &&
