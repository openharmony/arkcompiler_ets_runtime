...
public:
    ...
    ACCESSORS_PRIMITIVE_FIELD_ATOMIC(CallField, uint64_t, CALL_FIELD_OFFSET, NATIVE_POINTER_OR_BYTECODE_ARRAY_OFFSET)
    ...
    ACCESSORS_PRIMITIVE_FIELD_ATOMIC(ExtraLiteralInfo, uint64_t, EXTRA_LITERAL_INFO_OFFSET, LAST_OFFSET)
