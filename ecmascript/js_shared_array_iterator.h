...
#ifndef ECMASCRIPT_JS_SHARED_ARRAY_ITERATOR_H
#define ECMASCRIPT_JS_SHARED_ARRAY_ITERATOR_H

#include "ecmascript/js_iterator.h"
#include "ecmascript/js_object.h"

namespace panda::ecmascript {
class JSSharedArrayIterator : public JSObject {
public:
    ...
    ACCESSORS(IteratedArray, ITERATED_ARRAY_OFFSET, EXPECTED_MOD_COUNT_OFFSET)
    ACCESSORS_PRIMITIVE_FIELD(ExpectedModCount, uint32_t, EXPECTED_MOD_COUNT_OFFSET, NEXT_INDEX_OFFSET)
    ...
    DECL_VISIT_OBJECT_FOR_JS_OBJECT(JSObject, ITERATED_ARRAY_OFFSET, EXPECTED_MOD_COUNT_OFFSET)
    DECL_DUMP()
};
}  // namespace panda::ecmascript

#endif  // ECMASCRIPT_JS_SHARED_ARRAY_ITERATOR_H
