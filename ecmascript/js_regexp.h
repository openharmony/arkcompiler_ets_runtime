...
public:
    ...
    ACCESSORS_WITH_RB_MODE(OriginalSource, ORIGINAL_SOURCE_OFFSET, ORIGINAL_FLAGS_OFFSET)
    ACCESSORS_WITH_RB_MODE(OriginalFlags, ORIGINAL_FLAGS_OFFSET, GROUP_NAME_OFFSET)
