...
#ifndef ECMASCRIPT_MEM_CMS_MEM_SWEEP_GC_VISITOR_H
#define ECMASCRIPT_MEM_CMS_MEM_SWEEP_GC_VISITOR_H
...
class SweepGCMarkRootVisitor final : public RootVisitor {
public:
    inline explicit SweepGCMarkRootVisitor(WorkNodeHolder *workNodeHolder);
    ~SweepGCMarkRootVisitor() override = default;
...
class SweepGCMarkObjectVisitor final : public BaseObjectVisitor<SweepGCMarkObjectVisitor> {
public:
    inline explicit SweepGCMarkObjectVisitor(WorkNodeHolder *workNodeHolder);
    ~SweepGCMarkObjectVisitor() override = default;
