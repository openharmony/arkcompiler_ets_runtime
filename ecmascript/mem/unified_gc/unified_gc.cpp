...
{
    ECMA_BYTRACE_NAME(HITRACE_TAG_ARK, "UnifiedGC::Initialize");
    Runtime::GetInstance()->GCIterateThreadList([](JSThread *thread) {
        Heap *heap = const_cast<Heap *>(thread->GetEcmaVM()->GetHeap());
...
void UnifiedGC::Mark()
{
    ECMA_BYTRACE_NAME(HITRACE_TAG_ARK, "UnifiedGC::Mark");
    Runtime::GetInstance()->GCIterateThreadList([](JSThread *thread) {
        Heap *heap = const_cast<Heap *>(thread->GetEcmaVM()->GetHeap());
...
{
    ECMA_BYTRACE_NAME(HITRACE_TAG_ARK, "UnifiedGC::Finish");
