 ...
 */
#ifndef ARK_COMMON_GCREQUEST_H
#define ARK_COMMON_GCREQUEST_H
...
constexpr uint64_t MIN_ASYNC_GC_INTERVAL_NS = panda::SECOND_TO_NANO_SECOND;
constexpr uint64_t LONG_MIN_HEU_GC_INTERVAL_NS = 200 * panda::MILLI_SECOND_TO_NANO_SECOND;
