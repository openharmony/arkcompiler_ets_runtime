...
#ifndef COMMON_COMPONENTS_OBJECTS_STRING_TABLE_CHAINED_HASH_MAP_INL_H
#define COMMON_COMPONENTS_OBJECTS_STRING_TABLE_CHAINED_HASH_MAP_INL_H

#include "common_components/log/log.h"
#include "objects/readonly_handle.h"
#include "objects/string/base_string.h"
#include "objects/string/line_string-inl.h"
#include "common_components/objects/string_table/chained_hash_map.h"
                                                                             ...
                                                                             Entry* entry)
{
    ...
    if (SlotBarrier == ChainedHashMapConfig::NeedSlotBarrier) {
...
#endif //COMMON_COMPONENTS_OBJECTS_STRING_TABLE_CHAINED_HASH_MAP_INL_H
