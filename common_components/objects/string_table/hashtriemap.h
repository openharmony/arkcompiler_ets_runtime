...
#ifndef COMMON_COMPONENTS_OBJECTS_STRING_TABLE_HASH_TRIE_MAP_H
#define COMMON_COMPONENTS_OBJECTS_STRING_TABLE_HASH_TRIE_MAP_H
...
// Clear
template <typename Mutex, typename ThreadHolder>
void HashTrieMap<Mutex, ThreadHolder>::Clear()
{
...
#endif //COMMON_COMPONENTS_OBJECTS_STRING_TABLE_HASH_TRIE_MAP_H
