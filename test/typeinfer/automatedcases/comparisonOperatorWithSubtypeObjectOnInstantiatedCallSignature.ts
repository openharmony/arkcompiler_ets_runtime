...
let b1: { fn(x: string): string };
AssertType(b1, "{ fn(string): string; }");
AssertType(fn, "(string) => string");
AssertType(x, "string");
...
let b2: { fn(x: string, y: number): string };
AssertType(b2, "{ fn(string, number): string; }");
AssertType(fn, "(string, number) => string");
AssertType(x, "string");
AssertType(y, "number");

let a3: { fn<T, U>(x: T, y: U): T };
AssertType(a3, "{ fn<T, U>(T, U): T; }");
AssertType(fn, "<T, U>(T, U) => T");
AssertType(x, "T");
AssertType(y, "U");

let b3: { fn(x: string, y: number): string };
AssertType(b3, "{ fn(string, number): string; }");
AssertType(fn, "(string, number) => string");
AssertType(x, "string");
AssertType(y, "number");
...
let b4: { fn(x?: string): string };
AssertType(b4, "{ fn(?string): string; }");
AssertType(fn, "(?string) => string");
AssertType(x, "string");

let a5: { fn<T>(...x: T[]): T };
AssertType(a5, "{ fn<T>(...T[]): T; }");
AssertType(fn, "<T>(...T[]) => T");
AssertType(x, "T[]");

let b5: { fn(...x: string[]): string };
AssertType(b5, "{ fn(...string[]): string; }");
AssertType(fn, "(...string[]) => string");
AssertType(x, "string[]");

let a6: { fn<T>(x: T, y: T): T };
AssertType(a6, "{ fn<T>(T, T): T; }");
AssertType(fn, "<T>(T, T) => T");
AssertType(x, "T");
AssertType(y, "T");

let b6: { fn(x: string, y: number): {} };
AssertType(b6, "{ fn(string, number): {}; }");
AssertType(fn, "(string, number) => {}");
AssertType(x, "string");
AssertType(y, "number");

//let a7: { fn<T, U extends T>(x: T, y: U): T };
let b7: { fn(x: Base, y: Derived): Base };
AssertType(b7, "{ fn(Base, Derived): Base; }");
AssertType(fn, "(Base, Derived) => Base");
AssertType(x, "Base");
