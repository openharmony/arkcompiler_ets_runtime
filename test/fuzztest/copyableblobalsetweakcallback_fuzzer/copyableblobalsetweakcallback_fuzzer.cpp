...
#include "copyableblobalsetweakcallback_fuzzer.h"
...
namespace OHOS {
void CopyAbleblobalSetWeakCallBack_FuzzTest(const uint8_t *data, size_t size)
{
    ...
    copyGlobalStr.SetWeakCallback(&inputUnit32, FreeGlobalCallBack<uint32_t>, NativeFinalizeCallback<uint32_t>);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::CopyAbleblobalSetWeakCallBack_FuzzTest(data, size);
    return 0;
}