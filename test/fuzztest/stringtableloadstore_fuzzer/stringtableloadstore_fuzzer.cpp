...
void StringTableLoadStoreFuzzTest(const uint8_t* data, size_t size)
{
    ...
    chainedHashMapOperation.template Load<false>([](const void*, size_t) { return nullptr; }, key, nullptr);
    chainedHashMapOperation.template LoadOrStore<true>(
        thread, key, [value]() { return value; }, [](BaseString*) { return false; });
    delete map;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::StringTableLoadStoreFuzzTest(data, size);
    return 0;
}
