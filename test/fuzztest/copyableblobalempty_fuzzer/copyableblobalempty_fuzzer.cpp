...
#include "copyableblobalempty_fuzzer.h"
...
namespace OHOS {
    void CopyAblebolEmptyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::CopyAblebolEmptyFuzzTest(data, size);
    return 0;
}