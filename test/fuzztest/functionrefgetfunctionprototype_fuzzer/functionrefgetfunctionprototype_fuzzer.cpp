...
#include "functionrefgetfunctionprototype_fuzzer.h"
...
void FunctionRefGetFunctionPrototypeFuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::FunctionRefGetFunctionPrototypeFuzzTest(data, size);
    return 0;
}