...
#include "containerslistremovebyindex_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistRemoveByIndexFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        EcmaVM *vm = JSNApi::CreateJSVM(option);
        {
            ...
            ContainersList::RemoveByIndex(callInfo1);
        }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistRemoveByIndexFuzzTest(data, size);
    return 0;
}