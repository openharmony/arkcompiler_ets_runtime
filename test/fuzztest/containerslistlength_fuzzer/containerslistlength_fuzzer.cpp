...
#include "containerslistlength_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistLengthFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        EcmaVM *vm = JSNApi::CreateJSVM(option);
        {
            ...
            ContainersList::Length(callInfo1);
        }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistLengthFuzzTest(data, size);
    return 0;
}
