...
#include "containerslisthas_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistHasFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistHasFuzzTest(data, size);
    return 0;
}