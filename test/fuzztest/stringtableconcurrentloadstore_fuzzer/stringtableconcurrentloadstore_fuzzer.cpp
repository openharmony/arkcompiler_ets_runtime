...
void StringTableConcurrentLoadStoreFuzzTest(const uint8_t* data, size_t size)
{
    ...
    chainedHashMapOperation.template LoadOrStore<true>(
        thread, hashcode, [value]() { return value; }, [](BaseString*) { return false; });
    delete map;
