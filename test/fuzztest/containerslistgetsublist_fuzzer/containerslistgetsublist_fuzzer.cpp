...
#include "containerslistgetsublist_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainerslistGetSubListFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        EcmaVM *vm = JSNApi::CreateJSVM(option);
        {
            ...
            ContainersList::GetSubList(callInfo1);
        }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainerslistGetSubListFuzzTest(data, size);
    return 0;
}
