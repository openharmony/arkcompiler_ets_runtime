...
#include "jsvaluerefislist_fuzzer.h"
...
void JSValueRefIsListFuzzTest([[maybe_unused]] const uint8_t *data, [[maybe_unused]] size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::JSValueRefIsListFuzzTest(data, size);
    return 0;
}