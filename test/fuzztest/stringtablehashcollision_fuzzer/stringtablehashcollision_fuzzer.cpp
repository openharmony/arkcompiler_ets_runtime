...
#include "stringtablehashcollision_fuzzer.h"
...
namespace OHOS {
    ...
    void StringTableHashCollisionFuzzTest(const uint8_t *data, size_t size)
    {
        ...
        hashTrieMapOperation.template LoadOrStore<true>(thread, key1, [value]() { return value; },
                                                        [](BaseString *) { return false; });
        hashTrieMapOperation.template LoadOrStore<true>(thread, key2, [value]() { return value; },
                                                        [](BaseString *) { return false; });
        delete map;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::StringTableHashCollisionFuzzTest(data, size);
    return 0;
}