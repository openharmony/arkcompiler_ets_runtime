...
#include "builtinsarraybufferfastsetvalueinbuffer_fuzzer.h"
...
namespace OHOS {
    void BuiltinsArrayBufferFastSetValueInBufferFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::BuiltinsArrayBufferFastSetValueInBufferFuzzTest(data, size);
    return 0;
}