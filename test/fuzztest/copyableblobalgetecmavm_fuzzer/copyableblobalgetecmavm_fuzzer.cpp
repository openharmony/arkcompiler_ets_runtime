...
#include "copyableblobalgetecmavm_fuzzer.h"
...
namespace OHOS {
void CopyAbleblobalGetEcmaVM_FuzzTest(const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::CopyAbleblobalGetEcmaVM_FuzzTest(data, size);
    return 0;
}