...
#include "setrefgettotalelements_fuzzer.h"
...
namespace OHOS {
void SetRefGetTotalElementsFuzztest([[maybe_unused]]const uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::SetRefGetTotalElementsFuzztest(data, size);
    return 0;
}