...
/*
 * @tc.name:string_wrapper_instance_toprimitive_assign
 * @tc.desc:String wrapper to primitive detector test - instance toPrimitive assignment
 * @tc.type: FUNC
 */
