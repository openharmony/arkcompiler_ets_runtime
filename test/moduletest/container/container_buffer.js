...
if (globalThis["ArkPrivate"] != undefined) {
    ...
    }
    {
        ...
        buf.writeBigInt64BE(1145141919810n, 0);
        map.set("buffer.writeBigInt64BE() failed", buf.readBigInt64BE(0) === 1145141919810n);
      
        buf.writeBigInt64LE(1145141919810n, 0);
        map.set("buffer.writeUBigInt64LE() failed", buf.readBigInt64LE(0) === 1145141919810n);
      
        buf.writeBigUInt64BE(1145141919810n, 0);
        map.set("buffer.writeUBigInt64BE() failed", buf.readBigUInt64BE(0) === 1145141919810n);
      
        buf.writeBigUInt64LE(1145141919810n, 0);
        map.set("buffer.writeBigUInt64LE() failed", buf.readBigUInt64LE(0) === 1145141919810n);
    }
    ...
    }
    {
        ...
        temp.write("aGVsbG8gd29ybGQh", "base64");
...

    {
        ...
        uint8Arr[9] = 9;
        let bufObj = new FastBuffer(sharedArr, 5, 5);
        uint8Arr[1] = 10;
        map.set("create buffer overlap data data and toJSON failed, expect length: 5, output: " + bufObj.length, bufObj.length === 5);
        let res = JSON.stringify(bufObj);
        map.set('create buffer overlap data data and toJSON failed, expect: {"0":0,"1":0,"2":0,"3":0,"4":9}, output: ' + res, res === '{"0":0,"1":0,"2":0,"3":0,"4":9}');
    }
